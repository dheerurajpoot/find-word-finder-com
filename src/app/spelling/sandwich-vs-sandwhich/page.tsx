...
export const metadata: Metadata = {
  title: 'Sandwich vs Sandwhich - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;sandwich&quot; and &quot;sandwhich&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SandwichVsSandwhichPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Sandwhich</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-lime-50 border-lime-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-lime-900 mb-4">&quot;Sand&quot; (Root)</h3>
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-green-900 mb-4">&quot;wich&quot; (Suffix)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;I packed a tuna <strong>sandwich</strong> for lunch.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The bakery sells fresh <strong>sandwiches</strong>.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;Chicken salad <strong>sandwiches</strong> are delicious.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;BLT <strong>sandwiches</strong> are a classic choice.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I packed a tuna <strong>sandwhich</strong> for lunch&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sandwich&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The bakery sells fresh <strong>sandwhiches</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sandwiches&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Chicken salad <strong>sandwhiches</strong> are delicious&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sandwiches&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;BLT <strong>sandwhiches</strong> are a classic&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sandwiches&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-yellow-800">&quot;Sandwich&quot; has a &quot;d&quot;, not &quot;h&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-lime-50 border-lime-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-lime-900 mb-2">Think Food</h3>
              <p className="text-lime-800">&quot;Sandwich&quot; = food item, &quot;Sandwhich&quot; = wrong spelling</p>
            </CardContent>
          </Card>
          <Card className="bg-green-50 border-green-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-green-800">Practice writing &quot;sandwich&quot; to build muscle memory</p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Sandwich delivery</strong> - food service</li>
                <li>• <strong>Sandwich catering</strong> - event food</li>
                <li>• <strong>Sandwich platter</strong> - food display</li>
                <li>• <strong>Sandwich station</strong> - self-service</li>
                <li>• <strong>Sandwich combo</strong> - meal deal</li>
                <li>• <strong>Sandwich special</strong> - daily offer</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Noun:</strong> &quot;The sandwich is fresh&quot;</li>
                <li>• <strong>Verb:</strong> &quot;To sandwich between&quot;</li>
                <li>• <strong>Plural:</strong> &quot;Many sandwiches&quot;</li>
                <li>• <strong>Possessive:</strong> &quot;Sandwich&apos;s freshness&quot;</li>
                <li>• <strong>Compound:</strong> &quot;Sandwich-ordering system&quot;</li>
                <li>• <strong>Adjective:</strong> &quot;Sandwich ingredients&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-lime-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-lime-900 mb-3">Q: Why do people misspell &quot;sandwich&quot; as &quot;sandwhich&quot;?</h3>
          ...
          <Card className="border-l-4 border-emerald-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-emerald-900 mb-3">Q: What&apos;s the etymology of &quot;sandwich&quot;?</h3>
          ...
          <Card className="border-l-4 border-pink-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-pink-900 mb-3">Q: What&apos;s the difference between &quot;sandwich&quot; and &quot;toast&quot;?</h3>
              <p className="text-lg text-gray-700">A: A &quot;sandwich&quot; uses two slices of bread with filling between them, while &quot;toast&quot; refers to bread that has been browned by heat, which can be used to make sandwiches.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-lime-600 to-green-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Sandwhich&quot;</strong> is never correct in any context.
        </p>
