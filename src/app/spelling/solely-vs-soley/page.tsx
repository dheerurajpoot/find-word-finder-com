    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-amber-50 border-amber-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-amber-900 mb-4">✅ Correct: &quot;Solely&quot;</h3>
              <div className="space-y-3">
                <p className="text-amber-800"><strong>•</strong> &quot;I am solely responsible.&quot;</p>
                <p className="text-amber-800"><strong>•</strong> &quot;This is solely my decision.&quot;</p>
                <p className="text-amber-800"><strong>•</strong> &quot;She works solely from home.&quot;</p>
                <p className="text-amber-800"><strong>•</strong> &quot;The company focuses solely on quality.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Soley&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;I am soley responsible&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;This is soley my decision&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She works soley from home&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The company focuses soley on quality&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
