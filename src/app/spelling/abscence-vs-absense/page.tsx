...
export default function AbscenceVsAbsensePage() {
  return (
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Absence</span> (noun): The state of being away from a place or person; the lack or non-existence of something.
            </div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              ...
              <div className="text-lg md:text-xl text-muted-foreground">The state of being away from a place or person; the lack or non-existence of something.</div>
            </div>
          </Card>
        </div>
      </div>
