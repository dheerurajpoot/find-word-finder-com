...
export const metadata: Metadata = {
  title: 'Says vs Syas - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;says&quot; and &quot;syas&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SaysVsSyasPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-emerald-100 via-green-100 to-lime-100 p-8 rounded-2xl mb-10 border border-emerald-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Syas&quot; is always incorrect - remember the &quot;ay&quot; in &quot;says&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Syas</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-emerald-900 mb-4">&quot;Says&quot; (Verb)</h3>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Syas&quot; (Misspelling)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He <strong>syas</strong> he will be here&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;says&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She <strong>syas</strong> the movie was great&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;says&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The teacher <strong>syas</strong> homework is due&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;says&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;My friend <strong>syas</strong> it&apos;s going to rain&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;says&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-emerald-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-emerald-900 mb-3">Q: Why do people misspell &quot;says&quot; as &quot;syas&quot;?</h3>
              <p className="text-lg text-gray-700">A: This is a common phonetic spelling error. People often mix up the letter order when trying to spell based on pronunciation, leading to the incorrect &quot;syas&quot; spelling.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-amber-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Very important! Correct spelling ensures clear communication and prevents misunderstandings. Misspelling &quot;says&quot; as &quot;syas&quot; can confuse readers and make your writing appear less professional.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-green-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Syas&quot;</strong> is never correct in any context.
        </p>
