...
export const metadata: Metadata = {
  title: 'Beggar or Begger - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;beggar&quot; and &quot;begger&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function BeggarVsBeggerPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Beggar or Begger</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;beggar&quot; and &quot;begger&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Begger</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Begger&quot; is a misspelling. The correct spelling is &quot;beggar&quot; with &quot;ar&quot; at the end.</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <ul className="text-lg md:text-xl text-green-800 space-y-2">
                  <li>• The <strong>beggar</strong> stood on the corner.</li>
                  <li>• He gave food to the <strong>beggar</strong>.</li>
                  <li>• The <strong>beggar</strong> asked for help.</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-white shadow-md border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-red-900">Begger (noun):</h3>
              <p className="text-lg md:text-xl text-gray-800 leading-relaxed mb-2">&quot;Begger&quot; is a misspelling of &quot;beggar&quot; and is not a valid English word.</p>
              <div className="bg-red-50 p-4 rounded-lg">
                <h4 className="text-lg font-semibold mb-2 text-red-900">Examples:</h4>
                <ul className="text-lg md:text-xl text-red-800 space-y-2">
                  <li>• &quot;Begger&quot; is not used in standard English.</li>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-red-100">
            <CardContent className="p-6">
              <h4 className="text-xl font-semibold mb-2 text-red-900">Begger:</h4>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Beggar</strong> is spelled with &quot;ar&quot; at the end - this is the standard English spelling.</li>
            <li>• The word comes from the verb &quot;beg&quot; + the suffix &quot;-ar&quot; meaning one who does something.</li>
            <li>• &quot;Begger&quot; is never correct in any context.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;begger&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: No, &quot;begger&quot; is never correct. The proper spelling is always &quot;beggar.&quot;</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: Remember that &quot;beggar&quot; ends with &quot;ar&quot; - think of &quot;beg&quot; + &quot;ar.&quot;</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Beggar</strong> is the correct spelling with &quot;ar&quot; at the end. It means a person who asks for money or food from others. The misspelling &quot;begger&quot; is never correct in English.</p>
      </div>
    </div>
  )
} 