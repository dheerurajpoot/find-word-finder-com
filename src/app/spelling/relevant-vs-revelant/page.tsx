...
export const metadata: Metadata = {
  title: 'Relevant vs Revelant - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;relevant&quot; and &quot;revelant&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RelevantVsRevelantPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-pink-100 via-rose-100 to-red-100 p-8 rounded-2xl mb-10 border border-pink-200">
        <div className="text-center">
          ...
          <div className="inline-flex items-center bg-white px-6 py-3 rounded-full shadow-lg">
            ...
            <span className="text-2xl font-bold text-pink-600">&quot;Relevant&quot; is Correct</span>
            <span className="text-2xl ml-3">✅</span>
          </div>
          <p className="text-lg text-gray-700 mt-4">
            &quot;Revelant&quot; is always incorrect - remember the &quot;ant&quot; in &quot;relevant&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Revelant</h3>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-pink-50 to-pink-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-pink-800 mb-4">Relevant</h3>
              <div className="bg-white p-4 rounded-lg mb-4">
                <p className="text-xl text-pink-700 font-semibold">✅ CORRECT</p>
              </div>
              <p className="text-lg text-pink-700 leading-relaxed">
                This is the proper spelling meaning &quot;closely connected or appropriate.&quot;
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-pink-50 border-pink-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-pink-900 mb-2">ANT Rule</h3>
              <p className="text-pink-800">&quot;Relevant&quot; ends with &quot;ant&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-rose-50 border-rose-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-rose-900 mb-2">Think Relate</h3>
              <p className="text-rose-800">&quot;Relate&quot; + &quot;ant&quot; = &quot;relevant&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-red-800">Practice writing &quot;relevant&quot; to build muscle memory</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-pink-600 to-rose-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Relevant&quot;</strong> ends with &quot;ant&quot; and means &quot;closely connected.&quot; 
          <br />
          <strong>&quot;Revelant&quot;</strong> is missing the &quot;n&quot; and is never correct.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;RELATE + ANT&quot; - &quot;relevant&quot; ends with &quot;ant&quot;!</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/spelling/brilliant-vs-brillent" className="text-purple-700 hover:text-purple-900 underline">Brilliant vs Brillent</a></li>
