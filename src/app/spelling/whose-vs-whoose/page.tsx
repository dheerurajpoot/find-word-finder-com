...
export const metadata: Metadata = {
  title: "Whose vs Whoose - Correct Spelling and Usage Guide",
  description:
    "Learn the difference between 'whose' and 'whoose'. See which is correct, common misspellings, definitions, synonyms, usage notes, FAQs, and a summary to help you write with confidence.",
};

export default function WhoseVsWhoosePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Whose or Whoose</h1>
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-900">Whoose</h3>
            </div>
            <p className="text-lg md:text-xl text-red-800 mb-4">
              &quot;Whoose&quot; is a common misspelling and is not a recognized English word. The correct spelling is &quot;whose&quot; when indicating possession.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          ...
          <li>&quot;Whoose&quot; is a misspelling and should be avoided in all contexts.</li>
        </ul>
      </div>
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow p-5 border border-gray-200">
            <h3 className="text-lg md:text-xl font-semibold mb-2 text-gray-900">Is &quot;whoose&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-800">No, &quot;whoose&quot; is not a word in English. The correct spelling is &quot;whose&quot; for possession, or &quot;who&apos;s&quot; as a contraction for &quot;who is&quot;.</p>
          </div>
          <div className="bg-white rounded-lg shadow p-5 border border-gray-200">
          ...
          <div className="bg-white rounded-lg shadow p-5 border border-gray-200">
            ...
            <p className="text-lg md:text-xl text-gray-800">Example: &quot;Whose shoes are these?&quot;</p>
          </div>
        </div>
      </div>
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mt-8">
        ...
        <p className="text-lg md:text-xl text-green-900">
          Always use &quot;whose&quot; as the correct possessive form of &quot;who&quot;. &quot;Whoose&quot; is a misspelling and should be avoided.
        </p>
      </div>
    </div>
  );
