...
export const metadata: Metadata = {
  title: 'Royalties vs Royaltys - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;royalties&quot; and &quot;royaltys&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RoyaltiesVsRoyaltysPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Royaltys</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-pink-50 border-pink-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-pink-900 mb-4">&quot;Royalty&quot; (Singular)</h3>
          ...
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-rose-900 mb-4">&quot;Royalties&quot; (Plural)</h3>
          ...
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">Plural Rule</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>royaltys</strong> were paid quarterly&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;royalties&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;European <strong>royaltys</strong> gathered&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;royalties&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Book <strong>royaltys</strong> are income&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;royalties&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Multiple <strong>royaltys</strong> exist&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;royalties&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-pink-50 border-pink-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-pink-900 mb-2">Think Plural</h3>
              <p className="text-pink-800">Royalty → Royalties (y to ies)</p>
            </CardContent>
          </Card>
          <Card className="bg-rose-50 border-rose-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-rose-800">Practice writing &quot;royalties&quot; to build muscle memory</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-pink-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-pink-900 mb-3">Q: Why do people use &quot;royaltys&quot; instead of &quot;royalties&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from not knowing the standard English plural rule. When a word ends in consonant + y, you change the &quot;y&quot; to &quot;ies&quot; for the plural form. Many people forget this rule.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-rose-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-rose-900 mb-3">Q: What&apos;s the plural rule for words ending in &quot;y&quot;?</h3>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: No, &quot;royalties&quot; is spelled the same way across all English-speaking regions. The spelling &quot;royaltys&quot; is never correct in any dialect or region.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-blue-900 mb-3">Q: What are some synonyms for &quot;royalties&quot;?</h3>
          ...
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: What&apos;s the difference between &quot;royalty&quot; and &quot;royalties&quot;?</h3>
          ...
          <Card className="border-l-4 border-teal-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-teal-900 mb-3">Q: Do all words ending in &quot;y&quot; follow this rule?</h3>
      ...
      <div className="bg-gradient-to-r from-pink-600 to-rose-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Royaltys&quot;</strong> is never correct in any context.
        </p>
