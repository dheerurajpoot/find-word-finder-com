...
export const metadata: Metadata = {
  title: 'Chosen vs Chosed - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between "chosen" and "chosed". Discover definitions, usage examples, and common spelling mistakes.',
  keywords: 'chosen vs chosed, correct spelling, spelling comparison, English spelling, word confusion',
  openGraph: {
    title: 'Chosen vs Chosed - Which is Correct?',
    description: 'Learn the correct spelling between "chosen" and "chosed". Discover definitions, usage examples, and common spelling mistakes.',
    type: 'website',
  },
}

export default function ChosenVsChosedPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Chosen or Chosed</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-red-50 rounded-lg border-l-4 border-red-500">
          ...
          <p className="text-lg md:text-xl text-red-800 mb-4"><strong>Why it&apos;s wrong:</strong> This is a misspelling of &quot;chosen.&quot; The correct past participle of "choose" is "chosen"; "chosed" is not a word.</p>
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-4 rounded border-l-4 border-red-500">
            <p className="text-lg text-gray-800"><strong>Incorrect:</strong> &quot;She has <span className="text-red-600 font-semibold">chosed</span> the best option.&quot;</p>
          </div>
          <div className="bg-white p-4 rounded border-l-4 border-green-500">
      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-blue-200">
            <h3 className="text-xl font-semibold mb-3 text-blue-900">Q: Why do people misspell &quot;chosen&quot; as &quot;chosed&quot;?</h3>
          ...
          <div className="bg-white p-6 rounded-lg border border-blue-200">
            ...
            <p className="text-lg text-blue-800">A: Remember that &quot;chosen&quot; is the past participle, not &quot;chosed&quot;. The past tense is &quot;chose&quot;.</p>
          </div>
        </div>
      </div>
      {/* Summary Section */}
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mb-8">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          <strong>Chosen</strong> is the correct spelling. It is the past participle of &quot;choose&quot;. &quot;Chosed&quot; is a misspelling that should be avoided.
        </p>
      </div>
    </div>
  )
