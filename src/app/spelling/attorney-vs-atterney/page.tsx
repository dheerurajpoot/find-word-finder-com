...
export const metadata: Metadata = {
  title: 'Attorney vs Atterney - Which is Correct? | Word Tips',
  description: 'Learn the correct spelling between "attorney" and "atterney". Discover definitions, examples, and usage tips to avoid common spelling mistakes.',
  keywords: 'attorney, atterney, spelling, correct spelling, grammar, word comparison',
}

export default function AttorneyVsAtterneyPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Attorney or Atterney</h1>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8">
        ...
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
          The correct spelling is <strong>attorney</strong>. &quot;Atterney&quot; is a common misspelling that should be avoided in formal writing and communication.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
          ...
          <p className="text-lg md:text-xl text-red-800">
            This is an incorrect spelling. &quot;Atterney&quot; is not a valid word in the English language and should never be used.
          </p>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="text-lg md:text-xl text-gray-700 space-y-4">
          <p>
            <strong>Attorney</strong> (noun): A lawyer, especially one who represents clients in court or provides legal advice.
          </p>
          <p>
            <strong>Attorney</strong> can also refer to someone who is legally appointed to act on behalf of another person.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="text-lg md:text-xl text-gray-700 space-y-4">
          <div className="bg-green-50 p-4 rounded-lg">
            <p><strong>Correct:</strong> &quot;I need to consult with my attorney about this legal matter.&quot;</p>
          </div>
          <div className="bg-green-50 p-4 rounded-lg">
            <p><strong>Correct:</strong> &quot;The attorney presented a strong case in court.&quot;</p>
          </div>
          <div className="bg-green-50 p-4 rounded-lg">
            <p><strong>Correct:</strong> &quot;She hired an attorney to handle her divorce.&quot;</p>
          </div>
          <div className="bg-red-50 p-4 rounded-lg">
            <p><strong>Incorrect:</strong> &quot;I need to consult with my atterney about this legal matter.&quot;</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          <li>• Always use &quot;attorney&quot; with &quot;or&quot; in the middle, not &quot;er&quot;</li>
          <li>• The word comes from the Old French &quot;atorne&quot; meaning to turn to</li>
          <li>• &quot;Atterney&quot; is a phonetic misspelling that should be avoided</li>
          <li>• Remember: &quot;attorney&quot; has &quot;or&quot; like in &quot;attorney general&quot;</li>
        </ul>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Why do people misspell &quot;attorney&quot; as &quot;atterney&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              This misspelling occurs because people often confuse the &quot;or&quot; sound with &quot;er&quot; based on pronunciation, but the correct spelling uses &quot;or.&quot;
            </p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Is &quot;atterney&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              No, &quot;atterney&quot; is never correct in any context. It is always a spelling error.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">How can I remember the correct spelling?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              Think of the phrase &quot;attorney general&quot; - both words have &quot;or&quot; in them. This can help you remember the correct spelling.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">What is the difference between attorney and lawyer?</h3>
            <p className="text-lg md:text-xl text-gray-700">
