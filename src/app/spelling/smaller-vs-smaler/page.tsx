    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-emerald-900 mb-4">✅ Correct: &quot;Smaller&quot;</h3>
              <div className="space-y-3">
                <p className="text-emerald-800"><strong>•</strong> &quot;This box is smaller.&quot;</p>
                <p className="text-emerald-800"><strong>•</strong> &quot;She is smaller than him.&quot;</p>
                <p className="text-emerald-800"><strong>•</strong> &quot;The smaller size fits better.&quot;</p>
                <p className="text-emerald-800"><strong>•</strong> &quot;Choose the smaller option.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Smaler&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;This box is smaler&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She is smaler than him&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The smaler size fits better&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;Choose the smaler option&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-l-4 border-teal-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: &quot;Smaller&quot; comes from Old English &quot;smæl&quot; meaning &quot;thin&quot; or &quot;slender.&quot; The word evolved to mean &quot;little&quot; and the comparative form &quot;smaller&quot; follows standard English rules.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SMALL + ER = SMALLER&quot;</p>
        </div>
      </div>
