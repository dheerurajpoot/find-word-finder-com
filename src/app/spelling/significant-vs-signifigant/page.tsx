    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-purple-900 mb-4">✅ Correct: &quot;Significant&quot;</h3>
              <div className="space-y-3">
                <p className="text-purple-800"><strong>•</strong> &quot;This is a significant discovery.&quot;</p>
                <p className="text-purple-800"><strong>•</strong> &quot;The change was significant.&quot;</p>
                <p className="text-purple-800"><strong>•</strong> &quot;She made significant progress.&quot;</p>
                <p className="text-purple-800"><strong>•</strong> &quot;The results are significant.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Signifigant&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;This is a signifigant discovery&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The change was signifigant&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She made signifigant progress&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The results are signifigant&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SIGNIFICANT = C before A&quot;</p>
        </div>
      </div>
