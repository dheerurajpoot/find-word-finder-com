    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Searh the library&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;search&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Searh for clues&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;search&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Searh the files&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;search&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;A detailed searh&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;search&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;sear-C-h&quot; - remember the &quot;c&quot;!</p>
        </div>
      </div>
    </div>
  )
