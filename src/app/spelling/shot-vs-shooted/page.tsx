    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-rose-900 mb-4">✅ Correct: &quot;Shot&quot;</h3>
              <div className="space-y-3">
                <p className="text-rose-800"><strong>•</strong> &quot;He shot the target.&quot;</p>
                <p className="text-rose-800"><strong>•</strong> &quot;She shot the basketball.&quot;</p>
                <p className="text-rose-800"><strong>•</strong> &quot;They shot the movie.&quot;</p>
                <p className="text-rose-800"><strong>•</strong> &quot;I shot the photograph.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Shooted&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;He shooted the target&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She shooted the basketball&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;They shooted the movie&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;I shooted the photograph&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: &quot;Shot&quot; comes from the Old English word &quot;scēot&quot; meaning &quot;projectile, missile.&quot; It has been used in English since the 14th century as the irregular past tense of &quot;shoot.&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-rose-600 to-fuchsia-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SHOT = No Extra ED&quot;</p>
        </div>
      </div>
