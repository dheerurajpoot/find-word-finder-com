  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      ...
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-bold">Absent or Abcent</h1>
        <p className="text-muted-foreground text-sm">Which spelling is correct, Absent or Abcent, and how to use them properly.</p>
      </div>
        ...
        <Card className="flex-1 border-destructive/40">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-destructive text-base">
              <Badge variant="destructive">INCORRECT</Badge> Abcent
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-destructive text-sm">"Abcent" is not a correct English word.</p>
          </CardContent>
        </Card>
      ...
      <div>
        ...
        <div className="space-y-3">
          <Card>
            <CardContent>
              <span className="font-semibold">Is it abcent or absent?</span>
              <div className="text-sm text-muted-foreground">The correct word is "absent." "Abcent" is a common misspelling.</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
