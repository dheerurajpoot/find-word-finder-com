...
export const metadata: Metadata = {
  title: 'Quarantine vs Quarantaine - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;quarantine&quot; and &quot;quarantaine&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function QuarantineVsQuarantainePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-violet-100 via-purple-100 to-fuchsia-100 p-8 rounded-2xl mb-10 border border-violet-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Quarantaine&quot; is always incorrect - remember the &quot;i&quot; in &quot;quarantine&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Quarantaine</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-violet-900 mb-4">&quot;Quarantine&quot; (Correct)</h3>
          ...
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">&quot;Quarantaine&quot; (Incorrect)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The patient was placed in <strong>quarantaine</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;quarantine&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Travelers must undergo <strong>quarantaine</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;quarantine&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The ship was under <strong>quarantaine</strong> for 14 days&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;quarantine&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Health officials ordered <strong>quarantaine</strong> measures&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;quarantine&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">I for Isolation</h3>
              <p className="text-yellow-800">&quot;Quarantine&quot; ends with &quot;i&quot; - isolation!</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-violet-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-violet-900 mb-3">Q: Why do people misspell &quot;quarantine&quot; as &quot;quarantaine&quot;?</h3>
              <p className="text-lg text-gray-700">A: The misspelling &quot;quarantaine&quot; often occurs because people forget the final &quot;i&quot; or confuse it with similar words. The word comes from Italian &quot;quarantina.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-purple-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-purple-900 mb-3">Q: What&apos;s the etymology of &quot;quarantine&quot;?</h3>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Break down the word: &quot;quar-an-tine.&quot; Emphasize the &quot;i&quot; sound at the end and have them practice writing it multiple times. Use it in sentences to reinforce meaning.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-fuchsia-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-fuchsia-900 mb-3">Q: What&apos;s the difference between &quot;quarantine&quot; and &quot;isolation&quot;?</h3>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Quarantine&quot;</strong> has an &quot;i&quot; at the end and means &quot;isolation to prevent disease spread.&quot; 
          <br />
          <strong>&quot;Quarantaine&quot;</strong> is never correct in any context.
        </p>
