    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-pink-50 border-pink-200">
            <CardContent className="p-6">
              ...
              <ul className="text-pink-800 space-y-2">
                <li>• Means &quot;relating to love&quot;</li>
                <li>• Contains &quot;n&quot; sound</li>
          ...
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              ...
              <ul className="text-rose-800 space-y-2">
                <li>• People drop the &quot;n&quot;</li>
                <li>• &quot;Romatic&quot; is incomplete</li>
                <li>• Missing consonant sound</li>
                <li>• Always include &quot;n&quot;</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>romatic</strong> dinner was perfect&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;romantic&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She has <strong>romatic</strong> dreams&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;romantic&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The movie was very <strong>romatic</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;romantic&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He wrote <strong>romatic</strong> poetry&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;romantic&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Romantic dinner</strong> - intimate meal</li>
                <li>• <strong>Romantic getaway</strong> - love vacation</li>
                <li>• <strong>Romantic comedy</strong> - love story film</li>
                <li>• <strong>Romantic gesture</strong> - loving action</li>
                <li>• <strong>Romantic relationship</strong> - love connection</li>
                <li>• <strong>Romantic atmosphere</strong> - loving mood</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Adjective:</strong> &quot;The romantic evening&quot;</li>
                <li>• <strong>Predicate adjective:</strong> &quot;The evening is romantic&quot;</li>
                <li>• <strong>Comparative:</strong> &quot;More romantic&quot;</li>
                <li>• <strong>Superlative:</strong> &quot;Most romantic&quot;</li>
                <li>• <strong>Adverb form:</strong> &quot;Romantically&quot;</li>
                <li>• <strong>Noun form:</strong> &quot;Romanticism&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-red-600 to-pink-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;ROMANTIC&quot; includes the &quot;N&quot;</p>
        </div>
      </div>
