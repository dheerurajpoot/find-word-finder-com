...
export const metadata: Metadata = {
  title: "Celebrate vs. Celabrate — Spelling Comparison",
  description: "Learn the difference between 'celebrate' and 'celabrate', see correct spelling, definitions, usage, synonyms, notes, and FAQs.",
};

export default function CelebrateVsCelabratePage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Celebrate or Celabrate?</h1>
      <div className="mb-6 p-4 rounded-lg bg-gradient-to-r from-blue-100 to-blue-50">
        <p className="text-lg md:text-xl text-gray-800">Which is correct: <strong>celebrate</strong> or <strong>celabrate</strong>? Let&apos;s compare the spellings, meanings, and usage.</p>
      </div>
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        ...
        <div className="flex-1 bg-red-50 border-l-4 border-red-500 p-4 rounded-lg flex items-center">
          ...
          <div>
            <span className="font-bold text-lg md:text-xl text-red-800">Celabrate</span>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mb-8">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          <strong>Celebrate</strong> is the correct spelling, meaning to acknowledge a significant or happy day or event with a social gathering or enjoyable activity. <strong>Celabrate</strong> is a common misspelling and is not recognized in standard English.
        </p>
      </div>
      {/* Definition section */}
      <section className="mb-8">
        ...
        <div>
          <span className="font-bold text-lg md:text-xl">Celabrate:</span>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          ...
          <li>&quot;Celabrate&quot; is a misspelling and should be avoided in all writing.</li>
      ...
      <section>
        ...
        <div className="mb-4">
          <h3 className="font-semibold text-lg md:text-xl">Is &quot;celabrate&quot; ever correct?</h3>
          <p className="text-lg md:text-xl">No, &quot;celabrate&quot; is not a correct spelling in English. Always use &quot;celebrate&quot;.</p>
        </div>
        <div className="mb-4">
