    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-emerald-900 mb-4">✅ Correct: &quot;Solid&quot;</h3>
              <div className="space-y-3">
                <p className="text-emerald-800"><strong>•</strong> &quot;The wall is solid.&quot;</p>
                <p className="text-emerald-800"><strong>•</strong> &quot;She has solid evidence.&quot;</p>
                <p className="text-emerald-800"><strong>•</strong> &quot;This is a solid plan.&quot;</p>
                <p className="text-emerald-800"><strong>•</strong> &quot;The foundation is solid.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Sollid&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;The wall is sollid&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She has sollid evidence&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;This is a sollid plan&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The foundation is sollid&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SOL + I + D = SOLID&quot;</p>
        </div>
      </div>
