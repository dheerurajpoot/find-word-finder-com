  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Acknowledge or Acknowlege</h1>
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed bg-gray-50 rounded px-4 py-2 inline-block mx-auto max-w-xl">
          Which spelling is correct, Acknowledge or Acknowlege, and how to use them properly.
        </p>
      </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Acknowledge</span> (verb): To accept or admit the existence or truth of something; to recognize or show appreciation for.
            </div>
            <div className="mb-2 font-semibold text-lg md:text-xl">Examples:</div>
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>She refused to acknowledge her mistake.</li>
              <li>He acknowledged the receipt of the letter.</li>
              <li>The company acknowledged the contributions of its employees.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">How to pronounce acknowledge?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct pronunciation is /əkˈnɒlɪdʒ/ (uk-NOL-ij).</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">What does acknowledge mean?</div>
              <div className="text-lg md:text-xl text-muted-foreground">To accept or admit the existence or truth of something; to recognize or show appreciation for.</div>
            </div>
          </Card>
        </div>
      </div>
