...
export const metadata: Metadata = {
  title: 'Really vs Realy - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;really&quot; and &quot;realy&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function ReallyVsRealyPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-cyan-100 via-blue-100 to-indigo-100 p-8 rounded-2xl mb-10 border border-cyan-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Realy&quot; is always incorrect - remember the double &quot;l&quot; in &quot;really&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Realy</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-cyan-50 border-cyan-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-cyan-900 mb-4">&quot;Really&quot; (Correct)</h3>
          ...
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">&quot;Realy&quot; (Incorrect)</h3>
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <ul className="text-blue-800 space-y-2">
                <li>• Spelling: Double &quot;l&quot; vs single &quot;l&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;I <strong>really</strong> love this song.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;Do you <strong>really</strong> think so?&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;That&apos;s <strong>really</strong> interesting!&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;I <strong>really</strong> want to go home.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I <strong>realy</strong> love this song&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;really&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Do you <strong>realy</strong> think so?&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;really&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;That&apos;s <strong>realy</strong> interesting!&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;really&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I <strong>realy</strong> want to go home&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;really&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-yellow-800">&quot;Really&quot; has two &quot;l&quot;s - really long!</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-cyan-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-cyan-900 mb-3">Q: Why do people misspell &quot;really&quot; as &quot;realy&quot;?</h3>
              <p className="text-lg text-gray-700">A: The misspelling &quot;realy&quot; often occurs because people forget the double &quot;l&quot;. The word has a common structure that can be confusing to spell correctly.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-blue-900 mb-3">Q: What&apos;s the etymology of &quot;really&quot;?</h3>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Break down the word: &quot;real-ly.&quot; Emphasize the double &quot;l&quot; sound and have them practice writing it multiple times. Use it in sentences to reinforce meaning.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Really&quot;</strong> has double &quot;l&quot; and means &quot;truly&quot; or &quot;very.&quot; 
          <br />
          <strong>&quot;Realy&quot;</strong> is never correct in any context.
        </p>
