  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-bold">Absolutely or Absolutly</h1>
        <p className="text-muted-foreground text-sm">Which spelling is correct, Absolutely or Absolutly, and how to use them properly.</p>
      </div>
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Card className="flex-1 border-destructive/40">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-destructive text-base">
              <Badge variant="destructive">INCORRECT</Badge> Absolutly
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-destructive text-sm">"Absolutly" is not a correct English word.</p>
          </CardContent>
        </Card>
      ...
      <div>
        ...
        <div className="space-y-3">
          <Card>
            <CardContent>
              <span className="font-semibold">Is it absolutly or absolutely?</span>
              <div className="text-sm text-muted-foreground">The correct word is "absolutely." "Absolutly" is a common misspelling.</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
