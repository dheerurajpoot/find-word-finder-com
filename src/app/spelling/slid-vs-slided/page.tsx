    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-violet-900 mb-4">✅ Correct: &quot;Slid&quot;</h3>
              <div className="space-y-3">
                <p className="text-violet-800"><strong>•</strong> &quot;I slid down the hill.&quot;</p>
                <p className="text-violet-800"><strong>•</strong> &quot;She slid into the seat.&quot;</p>
                <p className="text-violet-800"><strong>•</strong> &quot;He slid the book across the table.&quot;</p>
                <p className="text-violet-800"><strong>•</strong> &quot;The car slid on the ice.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Slided&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;I slided down the hill&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She slided into the seat&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;He slided the book across the table&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The car slided on the ice&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-l-4 border-purple-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: &quot;Slid&quot; comes from Old English &quot;slīdan&quot; meaning &quot;to glide&quot; or &quot;slide.&quot; The word evolved to mean &quot;to move smoothly&quot; and follows irregular English past tense patterns.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-indigo-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SLID = Complete Word&quot;</p>
        </div>
      </div>
