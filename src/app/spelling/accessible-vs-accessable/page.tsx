    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            ...
            <p className="text-lg md:text-xl text-red-700">&quot;Accessable&quot; is a misspelling. The correct spelling is &quot;accessible&quot; with &quot;ible&quot; at the end.</p>
          </CardContent>
        </Card>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          <li>• <strong>Accessible</strong> is spelled with &quot;ible&quot; at the end, not &quot;able&quot;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: Think of it as &quot;access&quot; + &quot;ible&quot; - like &quot;access&quot; with &quot;ible&quot; ending, not &quot;able&quot;.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Accessible</strong> is the correct spelling with &quot;ible&quot; at the end. It means easy to reach, enter, or use. The misspelling &quot;accessable&quot; is never correct.</p>
      </div>
    </div>
  )
} 