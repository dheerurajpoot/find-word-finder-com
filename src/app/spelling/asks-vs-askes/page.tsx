      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
          ...
          <ul className="space-y-2">
            <li><a href="/spelling/dad-vs-dad" className="text-blue-700 hover:text-blue-900 underline">Dad vs Dad</a></li>
            <li><a href="/spelling/dance-vs-dance" className="text-blue-700 hover:text-blue-900 underline">Dance vs Dance</a></li>
            <li><a href="/spelling/dark-vs-dark" className="text-blue-700 hover:text-blue-900 underline">Dark vs Dark</a></li>
            <li><a href="/spelling/day-vs-day" className="text-blue-700 hover:text-blue-900 underline">Day vs Day</a></li>
            <li><a href="/spelling/dead-vs-dead" className="text-blue-700 hover:text-blue-900 underline">Dead vs Dead</a></li>
          </ul>
        </div>
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          ...
          <ul className="space-y-2">
            <li><a href="/spelling/inquires-vs-inquires" className="text-purple-700 hover:text-purple-900 underline">Inquires vs Inquires</a></li>
            <li><a href="/spelling/requests-vs-requests" className="text-purple-700 hover:text-purple-900 underline">Requests vs Requests</a></li>
            <li><a href="/spelling/seeks-vs-seeks" className="text-purple-700 hover:text-purple-900 underline">Seeks vs Seeks</a></li>
            <li><a href="/spelling/solicits-vs-solicits" className="text-purple-700 hover:text-purple-900 underline">Solicits vs Solicit</a></li>
            <li><a href="/spelling/petitions-vs-petitions" className="text-purple-700 hover:text-purple-900 underline">Petitions vs Petitions</a></li>
          </ul>
        </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/grammar/third-person-singular" className="text-green-700 hover:text-green-900 underline">Third Person Singular</a></li>
