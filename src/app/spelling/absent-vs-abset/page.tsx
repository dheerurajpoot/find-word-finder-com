...
export const metadata: Metadata = {
  title: "Absent or Abset - Which is Correct?",
  description: "Learn the correct spelling between &apos;absent&apos; and &apos;abset&apos;. Discover definitions, examples, and usage tips for these commonly confused words.",
};

export default function AbsentVsAbsetPage() {
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      {/* Title and subtitle */}
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Absent or Abset</h1>
        ...
        <div className="flex-1">
          <Card className="bg-red-50 border border-red-200 rounded-xl p-6 h-full flex flex-col justify-between shadow-none">
            <div>
              ...
              <div className="text-3xl font-extrabold text-red-600 mb-2">Abset</div>
              <div className="text-lg md:text-xl text-gray-700">
                This spelling is incorrect. &quot;Abset&quot; is not a valid word in English.
              </div>
            </div>
          </Card>
        </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>She was absent from school due to illness.</li>
              <li>The absent student missed the important lecture.</li>
              <li>His name was marked as absent on the attendance sheet.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded text-yellow-900 text-lg md:text-xl">
        <strong>Note:</strong> &quot;Absent&quot; is the correct spelling. &quot;Abset&quot; is a common misspelling—remember, it ends with &quot;-ent&quot; not &quot;-et&quot;.
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">Is it abset or absent?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct word is &quot;absent.&quot; &quot;Abset&quot; is a common misspelling.</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
          ...
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">How is absent used in school contexts?</div>
              <div className="text-lg md:text-xl text-muted-foreground">In schools, students are marked as absent when they don&apos;t attend class, and teachers track attendance records.</div>
            </div>
          </Card>
        </div>
      </div>
