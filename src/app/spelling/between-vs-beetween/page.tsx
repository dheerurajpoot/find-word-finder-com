...
export const metadata: Metadata = {
  title: 'Between or Beetween - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;between&quot; and &quot;beetween&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function BetweenVsBeetweenPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Between or Beetween</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;between&quot; and &quot;beetween&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Beetween</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Beetween&quot; is a misspelling. The correct spelling is &quot;between&quot; with one &quot;e&quot; after &quot;b&quot;.</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <ul className="text-lg md:text-xl text-green-800 space-y-2">
                  <li>• The book is <strong>between</strong> the two folders.</li>
                  <li>• Choose <strong>between</strong> these two options.</li>
                  <li>• The meeting is scheduled <strong>between</strong> 2 and 4 PM.</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-white shadow-md border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-red-900">Beetween (preposition/adverb):</h3>
              <p className="text-lg md:text-xl text-gray-800 leading-relaxed mb-2">&quot;Beetween&quot; is a misspelling of &quot;between&quot; and is not a valid English word.</p>
              <div className="bg-red-50 p-4 rounded-lg">
                <h4 className="text-lg font-semibold mb-2 text-red-900">Examples:</h4>
                <ul className="text-lg md:text-xl text-red-800 space-y-2">
                  <li>• &quot;Beetween&quot; is not used in standard English.</li>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-red-100">
            <CardContent className="p-6">
              <h4 className="text-xl font-semibold mb-2 text-red-900">Beetween:</h4>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Between</strong> is spelled with one &quot;e&quot; after &quot;b&quot; - this is the standard English spelling.</li>
            <li>• The word comes from Old English &quot;betweonum&quot; meaning among or in the middle.</li>
            <li>• &quot;Beetween&quot; is never correct in any context.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;beetween&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: No, &quot;beetween&quot; is never correct. The proper spelling is always &quot;between.&quot;</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: Remember that &quot;between&quot; has one &quot;e&quot; after &quot;b&quot; - think of &quot;be&quot; + &quot;tween.&quot;</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Between</strong> is the correct spelling with one &quot;e&quot; after &quot;b&quot;. It means in the space separating two things or among. The misspelling &quot;beetween&quot; is never correct in English.</p>
      </div>
    </div>
  )
} 