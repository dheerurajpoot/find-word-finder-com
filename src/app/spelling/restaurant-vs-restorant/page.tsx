...
export const metadata: Metadata = {
  title: 'Restaurant vs Restorant - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;restaurant&quot; and &quot;restorant&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RestaurantVsRestorantPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-lime-100 via-green-100 to-emerald-100 p-8 rounded-2xl mb-10 border border-lime-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Restorant&quot; is always incorrect - remember the &quot;au&quot; in &quot;restaurant&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Restorant</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-lime-50 border-lime-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-lime-900 mb-4">&quot;Restaur&quot; (Root)</h3>
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-green-900 mb-4">&quot;ant&quot; (Suffix)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The Italian <strong>restaurant</strong> was delicious.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;We found a great <strong>restaurant</strong> near the hotel.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The <strong>restaurant</strong> had excellent service.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;She manages a busy <strong>restaurant</strong> downtown.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The Italian <strong>restorant</strong> was&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;We found a great <strong>restorant</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>restorant</strong> had excellent&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She manages a busy <strong>restorant</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-lime-50 border-lime-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-lime-800">&quot;Restaurant&quot; = food place, &quot;Restorant&quot; = wrong spelling</p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Mexican restaurant</strong> - ethnic cuisine</li>
                <li>• <strong>Restaurant reservation</strong> - table booking</li>
                <li>• <strong>Restaurant delivery</strong> - food service</li>
                <li>• <strong>Restaurant hours</strong> - operating times</li>
                <li>• <strong>Restaurant parking</strong> - vehicle space</li>
                <li>• <strong>Restaurant website</strong> - online presence</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Noun:</strong> &quot;The restaurant was expensive&quot;</li>
                <li>• <strong>Subject:</strong> &quot;Restaurant closed early&quot;</li>
                <li>• <strong>Object:</strong> &quot;We love restaurant&quot;</li>
                <li>• <strong>Possessive:</strong> &quot;Restaurant&apos;s reputation&quot;</li>
                <li>• <strong>Plural:</strong> &quot;Several restaurants&quot;</li>
                <li>• <strong>Adjective:</strong> &quot;Restaurant quality&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-lime-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-lime-900 mb-3">Q: Why do people misspell &quot;restaurant&quot; as &quot;restorant&quot;?</h3>
          ...
          <Card className="border-l-4 border-emerald-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-emerald-900 mb-3">Q: What&apos;s the etymology of &quot;restaurant&quot;?</h3>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-blue-900 mb-3">Q: What&apos;s the difference between &quot;restaurant&quot; and &quot;bistro&quot;?</h3>
              <p className="text-lg text-gray-700">A: &quot;Restaurant&quot; is a general term for any dining establishment, while &quot;bistro&quot; specifically refers to a small, casual French-style restaurant with a simple menu and cozy atmosphere.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-lime-600 to-green-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Restorant&quot;</strong> is never correct in any context.
        </p>
