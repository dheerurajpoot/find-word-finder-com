...
export const metadata: Metadata = {
  title: 'Surprise vs Surprice - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;surprise&quot; and &quot;surprice&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SurpriseVsSurpricePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Surprice</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-lime-50 border-lime-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-lime-900 mb-4">&quot;Surprise&quot; (Noun/Verb)</h3>
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              ...
              <ul className="text-green-800 space-y-2">
                <li>• &quot;Surprice&quot; is wrong</li>
                <li>• Wrong ending &quot;-ce&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;What a nice <strong>surprice</strong>!&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I want to <strong>surprice</strong> her&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The party was a <strong>surprice</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Don&apos;t <strong>surprice</strong> me like that&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-yellow-800">&quot;Surprise&quot; ends with &quot;se&quot; like &quot;sense&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-blue-900 mb-2">Think Surprised</h3>
              <p className="text-blue-800">&quot;Surprise&quot; comes from &quot;surprised&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-lime-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-lime-900 mb-3">Q: Why do people misspell &quot;surprise&quot; as &quot;surprice&quot;?</h3>
              <p className="text-lg text-gray-700">A: The misspelling often occurs because many English words end with &quot;-ce&quot; (like &quot;price&quot;, &quot;nice&quot;, &quot;ice&quot;), so people assume &quot;surprise&quot; should follow the same pattern. However, the correct ending is &quot;-se.&quot;</p>
            </CardContent>
          </Card>

          <Card className="border-l-4 border-green-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-green-900 mb-3">Q: Is &quot;surprise&quot; related to &quot;surprised&quot;?</h3>
              <p className="text-lg text-gray-700">A: Yes! &quot;Surprise&quot; is the noun and verb form, while &quot;surprised&quot; is the adjective form. Both words come from the Old French &quot;surprendre&quot; meaning &quot;to overtake.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of the word &quot;surprised&quot; (which has the same spelling pattern) and remember that &quot;surprise&quot; ends with &quot;se.&quot; The &quot;se&quot; ending is crucial for the correct spelling.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-teal-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Yes! Think: &quot;When you&apos;re SURPRISED, you feel SURPRISE&quot; - both words have the same spelling pattern. Or remember: &quot;SUR + PRI + SE&quot; breaks down the word into manageable parts.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-lime-600 to-green-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Surprise&quot;</strong> ends with &quot;-se&quot; and means &quot;unexpected event.&quot; 
          <br />
          <strong>&quot;Surprice&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SUR + PRI + SE&quot; and remember the &quot;se&quot; ending like in &quot;sense&quot;!</p>
        </div>
      </div>
    </div>
  )
