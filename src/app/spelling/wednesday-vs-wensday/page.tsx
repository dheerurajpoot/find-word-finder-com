...
export const metadata: Metadata = {
  title: 'Wednesday or Wensday - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;Wednesday&quot; and &quot;Wensday&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function WednesdayVsWensdayPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Wednesday or Wensday</h1>
      
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;Wednesday&quot; and &quot;Wensday&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Wensday</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Wensday&quot; is a misspelling. The correct spelling is &quot;Wednesday&quot; with a &quot;d&quot; after the &quot;n&quot;.</p>
          </CardContent>
        </Card>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mb-8">
        ...
        <p className="text-lg md:text-xl text-green-800">
          <strong>Wensday</strong> is incorrect and should never be used in formal writing.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-red-700">
              <strong>Incorrect:</strong> &quot;I have a meeting on <span className="text-red-600 font-semibold">Wensday</span>&quot; (should be &quot;Wednesday&quot;)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          <li>• &quot;Wednesday&quot; is spelled with a &quot;d&quot; after the &quot;n&quot;</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Is &quot;Wensday&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">No, &quot;Wensday&quot; is never correct. The correct spelling is always &quot;Wednesday&quot; with a &quot;d&quot; after the &quot;n&quot;.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">What&apos;s the origin of the word &quot;Wednesday&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">It comes from Old English &quot;Wōdnesdæg&quot; meaning &quot;Woden&apos;s day&quot;, named after the Norse god Odin (Woden).</p>
          </div>
          
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Is it common to misspell &quot;Wednesday&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">Yes, many people incorrectly spell it as &quot;Wensday&quot;, possibly because the &quot;d&quot; is silent in pronunciation. This is a very common spelling mistake.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800">
          <strong>Wensday</strong> is always incorrect. Remember to include the silent &quot;d&quot; when writing this word.
        </p>
      </div>
    </div>
  )
