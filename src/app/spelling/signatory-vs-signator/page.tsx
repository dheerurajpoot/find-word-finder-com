    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-rose-900 mb-4">✅ Correct: &quot;Signatory&quot;</h3>
              <div className="space-y-3">
                <p className="text-rose-800"><strong>•</strong> &quot;He is a signatory to the agreement.&quot;</p>
                <p className="text-rose-800"><strong>•</strong> &quot;All signatories must be present.&quot;</p>
                <p className="text-rose-800"><strong>•</strong> &quot;The signatory approved the document.&quot;</p>
                <p className="text-rose-800"><strong>•</strong> &quot;She became a signatory last week.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Signator&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;He is a signator to the agreement&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;All signators must be present&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The signator approved the document&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She became a signator last week&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
