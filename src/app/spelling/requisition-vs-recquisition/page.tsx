...
export const metadata: Metadata = {
  title: 'Requisition vs Recquisition - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;requisition&quot; and &quot;recquisition&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RequisitionVsRecquisitionPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-orange-100 via-red-100 to-pink-100 p-8 rounded-2xl mb-10 border border-orange-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Recquisition&quot; is incorrect - remember the &quot;re&quot; not &quot;rec&quot; in &quot;requisition&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Recquisition</h3>
              <div className="bg-white p-4 rounded-lg mb-4">
                <p className="text-xl text-red-700 font-semibold">❌ INCORRECT</p>
              </div>
              <p className="text-lg text-red-700 leading-relaxed">
                This spelling has &quot;rec&quot; instead of &quot;re&quot; and is never acceptable in English.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Requisition&quot; (Correct)</h3>
              <ul className="text-orange-800 space-y-2">
                <li>• Starts with &quot;re&quot;</li>
          ...
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">&quot;Recquisition&quot; (Incorrect)</h3>
              <ul className="text-red-800 space-y-2">
                <li>• Has &quot;rec&quot; instead of &quot;re&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Please submit a <strong>recquisition</strong> for supplies&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>recquisition</strong> form&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;We received your <strong>recquisition</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>recquisition</strong> process&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">RE Rule</h3>
              <p className="text-yellow-800">&quot;Requisition&quot; starts with &quot;re&quot; like &quot;request&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-orange-50 border-orange-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-orange-900 mb-2">Think Request</h3>
              <p className="text-orange-800">&quot;Requisition&quot; starts like &quot;request&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-orange-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-orange-900 mb-3">Q: Why do people confuse &quot;requisition&quot; and &quot;recquisition&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from the similar pronunciation and the fact that &quot;rec&quot; might seem like a logical prefix. However, the correct spelling uses &quot;re&quot; as in &quot;request.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-pink-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-pink-900 mb-3">Q: How can I teach children the difference?</h3>
              <p className="text-lg text-gray-700">A: Use visual aids like &quot;requisition&quot; starting like &quot;request.&quot; Break down the word into syllables: re-qui-si-tion. Create simple sentences and have them identify which spelling is correct.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Can &quot;requisition&quot; be used in everyday conversation?</h3>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-blue-900 mb-3">Q: What&apos;s the difference between &quot;requisition&quot; and &quot;request&quot;?</h3>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-pink-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Requisition&quot;</strong> starts with &quot;re&quot; and means &quot;formal request.&quot; 
          <br />
          <strong>&quot;Recquisition&quot;</strong> has &quot;rec&quot; instead of &quot;re&quot; and is never correct.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;REQUISITION = REQUEST&quot; - both start with &quot;re&quot;!</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          ...
          <ul className="space-y-2">
            <li><a href="/spelling/request-vs-request" className="text-purple-700 hover:text-purple-900 underline">Request vs Request</a></li>
            <li><a href="/spelling/require-vs-require" className="text-purple-700 hover:text-purple-900 underline">Require vs Require</a></li>
            <li><a href="/spelling/return-vs-return" className="text-purple-700 hover:text-purple-900 underline">Return vs Return</a></li>
            <li><a href="/spelling/review-vs-review" className="text-purple-700 hover:text-purple-900 underline">Review vs Review</a></li>
