...
// Century vs Centuty spelling comparison page
import React from "react";
import Head from "next/head";

export default function CenturyVsCentuty() {
  return (
    <>
      <Head>
        <title>Century or Centuty - Which is Correct? Spelling Comparison</title>
        <meta name="description" content="Learn the difference between 'century' and 'centuty'. Find out the correct spelling, definitions, usage, and common mistakes." />
      </Head>
      <main className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Century or Centuty</h1>
        <div className="bg-gradient-to-r from-blue-100 to-blue-50 rounded-lg p-4 mb-6">
          <p className="text-lg md:text-xl text-gray-800">
            Unsure if you should write <strong>&quot;century&quot;</strong> or <strong>&quot;centuty&quot;</strong>? Here&apos;s a quick guide to help you use the correct spelling every time.
          </p>
        </div>
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-1 bg-red-50 border-l-4 border-red-500 rounded-lg p-6">
            <div className="flex items-center mb-2">
              ...
              <span className="text-xl font-bold text-red-700">Centuty</span>
            </div>
        ...
        <section className="mb-8">
          ...
          <div>
            <p className="text-lg md:text-xl"><strong>Centuty</strong>: <span className="text-red-700">(Incorrect spelling)</span></p>
          </div>
        </section>
        {/* Synonyms Section */}
        <section className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            ...
            <li>&quot;Centuty&quot; is a common typo or misspelling and should be avoided.</li>
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            <p className="font-semibold text-lg md:text-xl">Q: Is &quot;centuty&quot; ever correct?</p>
            <p className="text-lg md:text-xl">A: No, &quot;centuty&quot; is always a misspelling of &quot;century&quot;.</p>
          </div>
          <div className="mb-4">
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mt-8">
          ...
          <p className="text-lg md:text-xl text-green-800 leading-relaxed">
            <strong>Century</strong> is the correct spelling for a period of 100 years. <strong>Centuty</strong> is a misspelling and should not be used in any context.
          </p>
        </div>
      </main>
    </>
