...
export const metadata: Metadata = {
  title: 'Service vs Sarvice - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;service&quot; and &quot;sarvice&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function ServiceVsSarvicePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-emerald-100 via-teal-100 to-cyan-100 p-8 rounded-2xl mb-10 border border-emerald-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Sarvice&quot; is always incorrect - remember the &quot;c&quot; not &quot;v&quot; in &quot;service&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Sarvice</h3>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Sarvice&quot; (Incorrect)</h3>
              <ul className="text-orange-800 space-y-2">
                <li>• Not a real word</li>
                <li>• Common misspelling</li>
                <li>• Wrong letter &quot;v&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The customer <strong>sarvice</strong> was excellent&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;service&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;We provide a great <strong>sarvice</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;service&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The repair <strong>sarvice</strong> is available&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;service&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Thank you for your <strong>sarvice</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;service&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">C Not V Rule</h3>
              <p className="text-yellow-800">&quot;Service&quot; has &quot;c&quot; not &quot;v&quot;, just like &quot;serve&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Service&quot; = serve + ice, &quot;Sarvice&quot; = wrong</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Why do people confuse &quot;service&quot; and &quot;sarvice&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from pronunciation patterns where &quot;c&quot; and &quot;v&quot; can sound similar in some accents. Many people don&apos;t realize that &quot;service&quot; requires the &quot;c&quot; sound, not &quot;v.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Use visual aids like &quot;service&quot; having &quot;c&quot; not &quot;v&quot; (like &quot;serve&quot;), and create simple sentences. Have them identify which spelling is correct in context.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Service&quot;</strong> has &quot;c&quot; not &quot;v&quot; and means &quot;work done for others&quot; or &quot;assistance.&quot; 
          <br />
          <strong>&quot;Sarvice&quot;</strong> is never correct in any context.
        </p>
