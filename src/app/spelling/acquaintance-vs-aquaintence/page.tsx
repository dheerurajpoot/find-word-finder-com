...
export const metadata: Metadata = {
  title: "Acquaintance or Aquaintence - Which is Correct?",
  description: "Learn the correct spelling between 'acquaintance' and 'aquaintence'. Discover definitions, examples, and usage tips for these commonly confused words.",
};

export default function AcquaintanceVsAquaintencePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-8">Acquaintance or Aquaintence</h1>
      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-lg mb-8">
        ...
        <p className="text-lg md:text-xl text-center">
          Learn the difference between &quot;Acquaintance&quot; and &quot;Aquaintence&quot;. These are commonly confused spellings and how to use them correctly.
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
          <div className="text-3xl font-extrabold text-red-600 mb-2">❌ Aquaintence</div>
          <div className="text-lg md:text-xl text-red-700">
            This spelling is incorrect. &quot;Aquaintence&quot; is missing the &quot;c&quot; and has the wrong ending - it should be &quot;acquaintance.&quot;
          </div>
        </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-8">
        ...
        <div className="text-lg md:text-xl space-y-4">
          <p>
            <strong>Note:</strong> &quot;Acquaintance&quot; is the correct spelling. &quot;Aquaintence&quot; is a common misspelling—remember to include the &quot;c&quot; and use &quot;-ance&quot; not &quot;-ence.&quot;
          </p>
          <p>
            <strong>Tip:</strong> Think of &quot;acquaint&quot; + &quot;ance&quot; to remember the correct spelling. The word comes from Old French &quot;acointance&quot; meaning knowledge.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            <div className="font-semibold text-lg md:text-xl mb-1">Is it aquaintence or acquaintance?</div>
            <div className="text-lg md:text-xl text-muted-foreground">The correct spelling is &quot;acquaintance.&quot; &quot;Aquaintence&quot; is incorrect—it&apos;s missing the &quot;c&quot; and has the wrong ending.</div>
          </div>

          <div className="border-b border-gray-200 pb-4">
            <div className="font-semibold text-lg md:text-xl mb-1">How to pronounce acquaintance?</div>
            <div className="text-lg md:text-xl text-muted-foreground">It&apos;s pronounced as /əˈkweɪntəns/ (uh-KWAYN-tuhns).</div>
          </div>

          <div className="border-b border-gray-200 pb-4">
            <div className="font-semibold text-lg md:text-xl mb-1">What does acquaintance mean?</div>
            <div className="text-lg md:text-xl text-muted-foreground">Acquaintance means a person one knows slightly, but not as a close friend, or knowledge or experience of something.</div>
          </div>
          ...
          <div className="border-b border-gray-200 pb-4">
            <div className="font-semibold text-lg md:text-xl mb-1">Why is aquaintence wrong?</div>
            <div className="text-lg md:text-xl text-muted-foreground">Aquaintence is wrong because it&apos;s missing the &quot;c&quot; and uses &quot;-ence&quot; instead of &quot;-ance.&quot; The correct ending is &quot;-ance.&quot;</div>
          </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6 mt-8">
        ...
        <div className="text-lg md:text-xl space-y-4">
          <p>
            <strong>Correct spelling:</strong> Acquaintance
          </p>
          <p>
            <strong>Incorrect spelling:</strong> Aquaintence
          </p>
          <p>
            <strong>Meaning:</strong> A person one knows slightly, but not as a close friend; knowledge or experience of something.
          </p>
          <p>
            <strong>Remember:</strong> Always include the &quot;c&quot; in acquaintance and use &quot;-ance&quot; not &quot;-ence.&quot; Think of &quot;acquaint&quot; + &quot;ance&quot; to remember the correct spelling.
          </p>
        </div>
      </div>
    </div>
