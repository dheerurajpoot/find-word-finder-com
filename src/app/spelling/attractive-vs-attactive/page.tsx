...
export const metadata: Metadata = {
  title: 'Attractive vs Attactive - Which is Correct? | Word Tips',
  description: 'Learn the correct spelling between "attractive" and "attactive". Discover the proper usage, definitions, and common mistakes to avoid.',
}

export default function AttractiveVsAttactivePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      {/* Header */}
      <div className="text-center mb-8">
        <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Attractive or Attactive</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <Card className="border-2 border-red-200 bg-red-50 p-6">
          ...
          <div className="text-center">
            <div className="text-6xl font-bold text-red-600 mb-4">attactive</div>
      ...
      <Card className="mb-8 p-6">
        ...
        <div className="space-y-4 text-lg md:text-xl text-gray-700 leading-relaxed">
          <p>
            The confusion between &quot;attractive&quot; and &quot;attactive&quot; likely stems from:
          </p>
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><strong>Influence from other words:</strong> Words like &quot;active&quot; have &quot;t&quot; before &quot;c&quot;</li>
          </ul>
        </div>
      </Card>
      ...
      <Card className="mb-8 p-6">
        ...
        <div className="space-y-4 text-lg md:text-xl text-gray-700 leading-relaxed">
          <p>
            <strong>Spelling rule:</strong> The word &quot;attractive&quot; comes from the Latin word &quot;attractivus&quot; and follows 
            the standard English spelling pattern with &quot;c&quot; before &quot;t.&quot;
          </p>
          ...
          <p className="mt-4">
            <strong>Note:</strong> All related words follow the same spelling pattern with &quot;c&quot; before &quot;t.&quot;
          </p>
        </div>
      </Card>
      ...
      <Card className="mb-8 p-6">
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            ...
            <li>Remember that &quot;attractive&quot; uses &quot;c&quot; before &quot;t&quot;</li>
            ...
            <li>Always spell it as &quot;attractive&quot; not &quot;attactive&quot;</li>
      ...
      <Card className="mb-8 p-6">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Q: Is &quot;attactive&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              A: No, &quot;attactive&quot; is never correct in standard English. The correct spelling is always &quot;attractive.&quot;
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              A: Remember that &quot;attractive&quot; uses &quot;c&quot; before &quot;t.&quot; Think of it as &quot;attract&quot; + &quot;ive&quot; 
              or use the mnemonic: &quot;Attractive has &apos;c&apos; before &apos;t&apos; for &apos;charm&apos;.&quot;
            </p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Q: Is this a common spelling mistake?</h3>
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              A: Yes, this is a common spelling mistake. Many people transpose the &quot;c&quot; and &quot;t&quot; when writing &quot;attractive,&quot; 
          ...
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              A: The adverb form is &quot;attractively&quot; and it also follows the same spelling pattern with &quot;c&quot; before &quot;t.&quot;
            </p>
          </div>
        </div>
      </Card>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          ...
          The spelling &quot;attactive&quot; is incorrect and should never be used. Remember that &quot;attractive&quot; uses &quot;c&quot; before &quot;t&quot; 
