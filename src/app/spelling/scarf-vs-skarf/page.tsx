...
export const metadata: Metadata = {
  title: 'Scarf vs Skarf - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;scarf&quot; and &quot;skarf&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function ScarfVsSkarfPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-sky-100 via-blue-100 to-indigo-100 p-8 rounded-2xl mb-10 border border-sky-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Skarf&quot; is always incorrect - remember the &quot;c&quot; in &quot;scarf&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Skarf</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-sky-50 border-sky-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-sky-900 mb-4">&quot;Scarf&quot; (Noun/Verb)</h3>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Skarf&quot; (Misspelling)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Wool <strong>skarf</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scarf&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Silk <strong>skarf</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scarf&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Winter <strong>skarf</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scarf&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Warm <strong>skarf</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scarf&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">SC Sound</h3>
              <p className="text-yellow-800">Think of &quot;sc&quot; like &quot;school&quot; and &quot;science&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-blue-900 mb-2">C Before A</h3>
              <p className="text-blue-800">Remember: &quot;c&quot; comes before &quot;a&quot; in scarf</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-sky-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-sky-900 mb-3">Q: Why do people misspell &quot;scarf&quot; as &quot;skarf&quot;?</h3>
              <p className="text-lg text-gray-700">A: This is a common phonetic spelling error. The &quot;c&quot; in &quot;scarf&quot; is silent, so people often omit it when spelling based on pronunciation.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of &quot;scarf&quot; as containing &quot;sc&quot; like other words: school, science, score. The &quot;c&quot; is silent but important for spelling.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-sky-600 to-blue-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Scarf&quot;</strong> contains the &quot;c&quot; from &quot;sc&quot; and is the only correct spelling. 
          <br />
          <strong>&quot;Skarf&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SCARF = SC sound like SCHOOL&quot;</p>
        </div>
      </div>
    </div>
  )
