  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Uniform</strong> is the correct spelling for a distinctive set of clothing or consistency. The misspelling &quot;unaform&quot; is never correct. Use &quot;uniform&quot; in all writing and conversation.</p>
      </div>
    </div>
  )
} 