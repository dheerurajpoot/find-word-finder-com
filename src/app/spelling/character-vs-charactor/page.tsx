    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mt-8">
          ...
          <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Character</strong> is the correct spelling with &quot;er&quot; at the end. It means a person in a story or distinctive qualities. The misspelling &quot;charactor&quot; with &quot;or&quot; is never correct. Always use &quot;character&quot; when referring to personalities or story elements.</p>
        </div>
