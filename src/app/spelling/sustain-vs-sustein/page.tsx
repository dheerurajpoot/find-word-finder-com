...
export const metadata: Metadata = {
  title: 'Sustain vs Sustein - Correct Spelling & Word Definitions | Word Finder',
  description: 'Learn the correct spelling: &quot;sustain&quot; vs &quot;sustein&quot;. Understand word definitions, usage examples, and avoid common spelling mistakes.',
}

export default function SustainVsSusteinPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-8 rounded-2xl mb-10 border border-indigo-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Sustein&quot; is always incorrect - remember the &quot;ai&quot; in &quot;sustain&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Sustein</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The bridge can <strong>sustein</strong> heavy loads&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustain&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She <strong>susteined</strong> an injury&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustained&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The company <strong>susteins</strong> growth&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustains&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He <strong>susteined</strong> his argument&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustained&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">AI Rule</h3>
              <p className="text-yellow-800">&quot;Sustain&quot; has &quot;ai&quot; like &quot;rain&quot; and &quot;gain&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Sustain&quot; = support, &quot;Sustein&quot; = wrong</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Why do people confuse &quot;sustain&quot; and &quot;sustein&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from similar pronunciation and the fact that &quot;ei&quot; and &quot;ai&quot; can sound similar in some accents. Many people don&apos;t realize that &quot;sustain&quot; is spelled with &quot;ai.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Use visual aids showing &quot;sustain&quot; has &quot;ai&quot; in the middle (like &quot;rain&quot; and &quot;gain&quot;), and emphasize that &quot;sustein&quot; is not a real word. Create simple sentences and have them identify which spelling is correct.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-yellow-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of &quot;sustain&quot; as having &quot;ai&quot; in the middle like other words: rain, gain, sustain. The &quot;ai&quot; pattern is consistent and easy to remember.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-cyan-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Common misspellings include: sustein, sustain, sustain, sustain, and sustain. The correct spelling always has &quot;ai&quot; in the middle.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-violet-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-violet-900 mb-3">Q: Why do people often misspell &quot;sustain&quot; with &quot;ei&quot; instead of &quot;ai&quot;?</h3>
              <p className="text-lg text-gray-700">A: People often confuse &quot;ei&quot; and &quot;ai&quot; because they may not pronounce the &quot;a&quot; clearly, but &quot;sustain&quot; specifically has &quot;ai&quot; in the middle.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Sustain&quot;</strong> has &quot;ai&quot; in the middle and means &quot;to support or maintain.&quot; 
          <br />
          <strong>&quot;Sustein&quot;</strong> is never correct in any context.
        </p>
