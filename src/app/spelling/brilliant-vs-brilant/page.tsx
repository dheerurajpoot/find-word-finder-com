...
export const metadata: Metadata = {
  title: 'Brilliant or Brilant - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;brilliant&quot; and &quot;brilant&quot;. Discover definitions, examples, and usage tips for these commonly confused words.',
  keywords: 'brilliant, brilant, spelling, correct spelling, word comparison, English spelling, bright, intelligent',
  openGraph: {
    title: 'Brilliant or Brilant - Which is Correct?',
    description: 'Learn the correct spelling between &quot;brilliant&quot; and &quot;brilant&quot;. Discover definitions, examples, and usage tips.',
    type: 'website',
  },
}

export default function BrilliantVsBrilantPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Brilliant or Brilant</h1>
      
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-lg mb-8">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl opacity-90">
          Understanding the correct spelling of &quot;Brilliant&quot; and &quot;Brilant&quot;. This is an adjective meaning exceptionally bright, intelligent, or outstanding.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
          ...
          <p className="text-lg md:text-xl text-red-800 mb-4">
            This spelling is <strong>incorrect</strong>. &quot;Brilant&quot; is a misspelling of the word &quot;brilliant.&quot;
          </p>
          <div className="bg-red-100 p-4 rounded">
            <p className="text-red-900 font-semibold">Incorrect Examples:</p>
            <ul className="text-red-800 mt-2 space-y-1">
              <li>• She had a brilant idea</li>
              <li>• The brilant sun shone brightly</li>
              <li>• He is a brilant student</li>
            </ul>
          </div>
        </div>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          ...
          <li>• &quot;Brilant&quot; is a common misspelling but is never correct</li>
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Q: Why do people spell it &quot;brilant&quot;?</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Q: Is &quot;brilant&quot; ever acceptable?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              A: No, &quot;brilant&quot; is always incorrect. Always use &quot;brilliant&quot; in all contexts.
            </p>
          </div>
          <div>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <div className="text-lg md:text-xl text-green-800 space-y-4">
          <p>
            <strong>Brilliant</strong> is the correct spelling of this word. The incorrect spelling &quot;brilant&quot; should never be used.
          </p>
          <p>
