...
export const metadata: Metadata = {
  title: "Acquaintance or Aquaintance - Which is Correct?",
  description: "Learn the correct spelling between 'acquaintance' and 'aquaintance'. Discover definitions, examples, and usage tips for these commonly confused words.",
};

export default function AcquaintanceVsAquaintancePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-8">Acquaintance or Aquaintance</h1>
      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-lg mb-8">
        ...
        <p className="text-lg md:text-xl text-center">
          Learn the difference between &quot;Acquaintance&quot; and &quot;Aquaintance&quot;. These are commonly confused spellings and how to use them correctly.
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
          <div className="text-3xl font-extrabold text-red-600 mb-2">❌ Aquaintance</div>
          <div className="text-lg md:text-xl text-red-700">
            This spelling is incorrect. &quot;Aquaintance&quot; is missing the &quot;c&quot; - it should be &quot;acquaintance.&quot;
          </div>
        </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-8">
        ...
        <div className="text-lg md:text-xl space-y-4">
          <p>
            <strong>Note:</strong> &quot;Acquaintance&quot; is the correct spelling. &quot;Aquaintance&quot; is a common misspelling—remember to include the &quot;c&quot; after the &quot;a.&quot;
          </p>
          <p>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            <div className="font-semibold text-lg md:text-xl mb-1">Is it aquaintance or acquaintance?</div>
            <div className="text-lg md:text-xl text-muted-foreground">The correct spelling is &quot;acquaintance.&quot; &quot;Aquaintance&quot; is incorrect—it&apos;s missing the &quot;c.&quot;</div>
          </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6 mt-8">
        ...
        <div className="text-lg md:text-xl space-y-4">
          ...
          <p>
            <strong>Incorrect spelling:</strong> Aquaintance
          </p>
          <p>
            <strong>Meaning:</strong> A person one knows slightly, but not as a close friend; knowledge or experience of something.
          </p>
          <p>
            <strong>Remember:</strong> Always include the &quot;c&quot; in acquaintance. Think of &quot;acquaint&quot; + &quot;ance&quot; to remember the correct spelling.
          </p>
        </div>
      </div>
    </div>
