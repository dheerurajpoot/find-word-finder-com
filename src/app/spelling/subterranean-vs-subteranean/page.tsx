...
export const metadata: Metadata = {
  title: 'Subterranean vs Subteranean - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;subterranean&quot; and &quot;subteranean&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SubterraneanVsSubteraneanPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-violet-100 via-purple-100 to-fuchsia-100 p-8 rounded-2xl mb-10 border border-violet-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Subteranean&quot; is incorrect - remember the &quot;r&quot; in &quot;terra&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Subteranean</h3>
              <div className="bg-white p-4 rounded-lg mb-4">
                <p className="text-xl text-red-700 font-semibold">❌ INCORRECT</p>
              </div>
              <p className="text-lg text-red-700 leading-relaxed">
                This spelling is missing the &quot;r&quot; in &quot;terra&quot; and is never acceptable in English.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-purple-900 mb-4">&quot;Terra&quot; (Root)</h3>
          ...
          <Card className="bg-fuchsia-50 border-fuchsia-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-fuchsia-900 mb-4">&quot;Ean&quot; (Suffix)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The <strong>subterranean</strong> lake is crystal clear.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;They found <strong>subterranean</strong> fossils.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The <strong>subterranean</strong> railway system is efficient.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;Ancient <strong>subterranean</strong> temples were uncovered.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>subteranean</strong> lake&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subterranean&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Subteranean fossils&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subterranean&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Subteranean railway&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subterranean&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Subteranean temples&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subterranean&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-yellow-800">&quot;Terra&quot; means earth, remember the &quot;r&quot; in terra</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Terra&quot; root always has two &quot;r&quot;s</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-violet-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-violet-900 mb-3">Q: Why do people misspell &quot;subterranean&quot; as &quot;subteranean&quot;?</h3>
              <p className="text-lg text-gray-700">A: The most common error is dropping the &quot;r&quot; from the &quot;terra&quot; root. This happens because the word is long and complex, and people often forget that &quot;terra&quot; always has two &quot;r&quot;s.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Break it down: &quot;sub&quot; + &quot;terra&quot; + &quot;ean.&quot; Remember that &quot;terra&quot; always has two &quot;r&quot;s, just like &quot;terrestrial&quot; and &quot;extraterrestrial.&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Subterranean&quot;</strong> has the complete &quot;terra&quot; root with two &quot;r&quot;s. 
          <br />
          <strong>&quot;Subteranean&quot;</strong> is missing the &quot;r&quot; and is incorrect.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SUB + TERRA + EAN&quot; - the &quot;r&quot; in terra is essential!</p>
        </div>
      </div>
    </div>
  )
