  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Temperature</strong> is the correct spelling with &quot;er&quot;: tem-per-a-ture. It means the degree of heat or cold in a body or environment. The misspelling &quot;temprature&quot; is never correct. Always use &quot;temperature&quot; when referring to thermal measurements.</p>
      </div>
