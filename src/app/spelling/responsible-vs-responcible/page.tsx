...
export const metadata: Metadata = {
  title: 'Responsible vs Responcible - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;responsible&quot; and &quot;responcible&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function ResponsibleVsResponciblePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-rose-100 via-pink-100 to-purple-100 p-8 rounded-2xl mb-10 border border-rose-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Responcible&quot; is always incorrect - remember the &quot;s&quot; before &quot;i&quot; in &quot;responsible&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Responcible</h3>
              <div className="bg-white p-4 rounded-lg mb-4">
                <p className="text-xl text-red-700 font-semibold">❌ INCORRECT</p>
              </div>
              <p className="text-lg text-red-700 leading-relaxed">
                This spelling is missing the &quot;s&quot; before &quot;i&quot; and is never acceptable in English.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Responcible&quot; (Incorrect)</h3>
              <ul className="text-orange-800 space-y-2">
                <li>• Missing &quot;s&quot; before &quot;i&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;He is a <strong>responsible</strong> driver.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;She shows <strong>responsible</strong> behavior.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The company is <strong>responsible</strong> for quality.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;Be <strong>responsible</strong> with resources.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He is a <strong>responcible</strong> driver&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;responsible&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She shows <strong>responcible</strong> behavior&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;responsible&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The company is <strong>responcible</strong> for quality&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;responsible&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Be <strong>responcible</strong> with resources&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;responsible&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">S Before I Rule</h3>
              <p className="text-yellow-800">&quot;Responsible&quot; has &quot;s&quot; before &quot;i&quot; like &quot;response&quot;</p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Responsible driver</strong> - safe motorist</li>
                <li>• <strong>Responsible behavior</strong> - mature conduct</li>
                <li>• <strong>Responsible quality</strong> - accountable standards</li>
                <li>• <strong>Responsible resource use</strong> - careful management</li>
                <li>• <strong>Responsible leadership</strong> - accountable management</li>
                <li>• <strong>Responsible planning</strong> - careful preparation</li>
              </ul>
            </div>
            <div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Why do people confuse &quot;responsible&quot; and &quot;responcible&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from the similar pronunciation and the fact that many English words have silent letters. People might drop the &quot;s&quot; before &quot;i&quot; because it&apos;s not strongly pronounced.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-purple-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-purple-900 mb-3">Q: What&apos;s the difference between &quot;responsible&quot; and &quot;responcible&quot;?</h3>
              <p className="text-lg text-gray-700">A: &quot;Responsible&quot; is the correct spelling meaning &quot;accountable for actions or duties.&quot; &quot;Responcible&quot; is not a real word and should never be used.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of the word &quot;response&quot; - &quot;responsible&quot; is &quot;response&quot; + &quot;ible.&quot; Also remember that &quot;response&quot; has &quot;s&quot; before &quot;i&quot;, so &quot;responsible&quot; should too.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-rose-600 to-pink-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Responsible&quot;</strong> has &quot;s&quot; before &quot;i&quot; and means &quot;accountable.&quot; 
          <br />
          <strong>&quot;Responcible&quot;</strong> is missing the &quot;s&quot; and is never correct.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;RESPONSE + IBLE&quot; - both have &quot;s&quot; before &quot;i&quot;!</p>
        </div>
      </div>
