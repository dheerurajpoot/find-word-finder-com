...
export default function AbsenseVsAbsencePage() {
  return (
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Absence</span> (noun): The state of being away from a place or person; lack of presence; nonattendance.
            </div>
            ...
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              ...
              <li>She was marked absent from class yesterday.</li>
            </ul>
          </div>
        </Card>
      </div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              ...
              <div className="text-lg md:text-xl text-muted-foreground">The state of being away from a place or person; lack of presence; nonattendance.</div>
            </div>
          </Card>
        </div>
      </div>
