...
export const metadata: Metadata = {
  title: 'Sauerkraut vs Sourkraut - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;sauerkraut&quot; and &quot;sourkraut&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SauerkrautVsSourkrautPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-lime-100 via-green-100 to-emerald-100 p-8 rounded-2xl mb-10 border border-lime-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Sourkraut&quot; is always incorrect - remember the &quot;auer&quot; in &quot;sauerkraut&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Sourkraut</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-lime-50 border-lime-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-lime-900 mb-4">&quot;Sauerkraut&quot; (Noun)</h3>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Sourkraut&quot; (Misspelling)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I love <strong>sourkraut</strong> on my hot dog&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sauerkraut&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>sourkraut</strong> is very tangy&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sauerkraut&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She makes homemade <strong>sourkraut</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sauerkraut&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>sourkraut</strong> recipe is traditional&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sauerkraut&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-lime-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-lime-900 mb-3">Q: Why do people misspell &quot;sauerkraut&quot; as &quot;sourkraut&quot;?</h3>
              <p className="text-lg text-gray-700">A: This is a common phonetic spelling error. People often spell it based on how it sounds in English (&quot;sour&quot; + &quot;kraut&quot;) rather than using the correct German spelling.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of &quot;sauerkraut&quot; as a German word. Remember the &quot;auer&quot; part - it&apos;s not &quot;sour&quot; but &quot;sauer&quot; in German.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-amber-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Very important! Correct spelling demonstrates knowledge of food culture and professionalism. Misspelling &quot;sauerkraut&quot; as &quot;sourkraut&quot; can make your culinary writing appear less credible.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-lime-600 to-green-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Sourkraut&quot;</strong> is never correct in any context.
        </p>
