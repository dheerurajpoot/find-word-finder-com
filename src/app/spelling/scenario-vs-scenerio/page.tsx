    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              ...
              <ul className="text-rose-800 space-y-2">
                <li>• Means &quot;situation&quot; or &quot;sequence&quot;</li>
                <li>• Ends with &quot;io&quot;</li>
                <li>• From Italian &quot;scenario&quot;</li>
                <li>• Used in planning contexts</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Worst-case <strong>scenerio</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenario&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;This <strong>scenerio</strong> could happen&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenario&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Every <strong>scenerio</strong> possible&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenario&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>scenerio</strong> was unlikely&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenario&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Worst-case scenario</strong> - most negative outcome</li>
                <li>• <strong>Best-case scenario</strong> - most positive outcome</li>
                <li>• <strong>Likely scenario</strong> - probable outcome</li>
                <li>• <strong>Unlikely scenario</strong> - improbable outcome</li>
                <li>• <strong>Realistic scenario</strong> - practical outcome</li>
                <li>• <strong>Hypothetical scenario</strong> - imagined situation</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Subject:</strong> &quot;The scenario was complex&quot;</li>
                <li>• <strong>Object:</strong> &quot;We discussed the scenario&quot;</li>
                <li>• <strong>Predicate:</strong> &quot;That&apos;s the scenario&quot;</li>
                <li>• <strong>Modifier:</strong> &quot;Scenario planning&quot;</li>
                <li>• <strong>Appositive:</strong> &quot;The situation, worst-case scenario&quot;</li>
                <li>• <strong>Prepositional object:</strong> &quot;In this scenario&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-rose-600 to-pink-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SCENARIO = Italian word with IO ending&quot;</p>
        </div>
      </div>
    </div>
  )
