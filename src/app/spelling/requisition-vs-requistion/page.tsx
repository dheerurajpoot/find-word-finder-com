...
export const metadata: Metadata = {
  title: 'Requisition vs Requistion - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;requisition&quot; and &quot;requistion&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RequisitionVsRequistionPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-violet-100 via-purple-100 to-fuchsia-100 p-8 rounded-2xl mb-10 border border-violet-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Requistion&quot; is incorrect - remember the &quot;si&quot; in &quot;requisition&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Requistion</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-violet-900 mb-4">&quot;Requisition&quot; (Correct)</h3>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Requistion&quot; (Incorrect)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Please submit a <strong>requistion</strong> for supplies&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>requistion</strong> form&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;We received your <strong>requistion</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>requistion</strong> process&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;requisition&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-violet-50 border-violet-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-violet-900 mb-2">Think Vision</h3>
              <p className="text-violet-800">&quot;Requisition&quot; ends like &quot;vision&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-violet-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-violet-900 mb-3">Q: Why do people confuse &quot;requisition&quot; and &quot;requistion&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from the complex spelling and the fact that &quot;requistion&quot; might seem like a logical shortening. However, the &quot;si&quot; is essential to the word&apos;s meaning and etymology.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Requistion&quot;</strong> is missing &quot;si&quot; and is never correct.
        </p>
