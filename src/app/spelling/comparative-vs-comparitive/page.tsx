...
export const metadata: Metadata = {
  title: 'Comparative or Comparitive - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;comparative&quot; and &quot;comparitive&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function ComparativeVsComparitivePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Comparative or Comparitive</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <p className="text-lg md:text-xl text-blue-900 leading-relaxed">
          Understanding the difference between &quot;comparative&quot; and &quot;comparitive&quot; is essential for clear communication. 
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-red-900">Comparitive</h2>
            </div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-gray-800">
              <strong>Incorrect:</strong> &quot;The <span className="text-red-600 font-semibold">comparitive</span> study showed significant differences between the groups.&quot;
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border-l-4 border-blue-500">
            <p className="text-lg md:text-xl text-gray-800">
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          ...
          <li>• It ends with &quot;ative&quot;, not &quot;itive&quot;</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Is &quot;comparitive&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              No, &quot;comparitive&quot; is never correct. It is always a misspelling of &quot;comparative&quot;. 
              There is no valid English word spelled as &quot;comparitive&quot;.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            ...
            <p className="text-lg md:text-xl text-gray-700">
              ...
              Since &quot;compare&quot; ends with &quot;e&quot;, the adjective form uses &quot;ative&quot; not &quot;itive&quot;. 
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Why do people misspell it as &quot;comparitive&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              This misspelling likely occurs because people confuse it with words that end in &quot;itive&quot; like &quot;definitive&quot;, 
              &quot;positive&quot;, or &quot;relative&quot;. However, &quot;comparative&quot; follows a different pattern.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          <strong>Comparative</strong> is the correct spelling, while <strong>comparitive</strong> is always incorrect. 
          &quot;Comparative&quot; is the adjective form of &quot;compare&quot;, ending with &quot;ative&quot; not &quot;itive&quot;. 
          ...
          and avoiding confusion with words that end in &quot;itive&quot;.
        </p>
      </div>
    </div>
  )
