...
export const metadata: Metadata = {
  title: 'Afford vs Affort - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;afford&quot; and &quot;affort&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function AffordVsAffortPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Afford vs Affort</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Understanding the difference between &quot;Afford&quot; or &quot;Affort&quot;: these commonly confused spellings and how to use them properly.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Affort</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Affort&quot; is a misspelling. The correct spelling is &quot;afford&quot; with a &apos;d&apos; at the end.</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Afford</strong> is spelled with a &apos;d&apos; at the end, not a &apos;t&apos;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;affort&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: No, &quot;affort&quot; is never correct. The proper spelling is always &quot;afford&quot; with a &apos;d&apos; at the end.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: How do I remember the correct spelling?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: Remember &quot;afford&quot; ends with &quot;ord&quot; like &quot;word&quot; or &quot;record&quot;. The word comes from Old English &quot;geforthian&quot;.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: The misspelling &quot;affort&quot; likely occurs because of confusion with similar-sounding words or uncertainty about the ending.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Afford</strong> is the correct spelling with a &apos;d&apos; at the end. It means to have enough money, time, or resources to do something. The misspelling &quot;affort&quot; is never correct. Use this word when talking about means, resources, or providing something.</p>
      </div>
    </div>
  )
} 