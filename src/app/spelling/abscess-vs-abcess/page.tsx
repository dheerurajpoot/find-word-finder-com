...
export default function AbscessVsAbcessPage() {
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      {/* Title and subtitle */}
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Abscess or Abcess</h1>
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed bg-gray-50 rounded px-4 py-2 inline-block mx-auto max-w-xl">
          Which spelling is correct, Abscess or Abcess, and how to use them properly.
        </p>
      </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Abscess</span> (noun): A swollen area within body tissue containing pus; a localized collection of pus.
            </div>
            <div className="mb-2 font-semibold text-lg md:text-xl">Examples:</div>
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>The dentist treated the abscess in his tooth.</li>
              <li>She developed an abscess after the surgery.</li>
              <li>The doctor drained the abscess to relieve the pain.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div className="space-y-8">
        <Card className="bg-blue-50">
          <div className="p-6">
            ...
            <div className="font-semibold mb-2 text-lg md:text-xl">Words with similar meanings to "abscess":</div>
            <div className="flex flex-col sm:flex-row justify-between gap-12">
              <div className="min-w-[220px]">
                <div className="font-semibold text-lg md:text-xl">Medical Terms:</div>
                <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
                  <li>Boil</li>
                  <li>Pustule</li>
                  <li>Infection</li>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">What does abscess mean?</div>
              <div className="text-lg md:text-xl text-muted-foreground">A swollen area within body tissue containing pus; a localized collection of pus.</div>
            </div>
          </Card>
        </div>
      </div>
