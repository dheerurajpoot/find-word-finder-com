...
export const metadata: Metadata = {
  title: 'Conscientious or Concientous - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;conscientious&quot; and &quot;concientous&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function ConscientiousVsConcientousPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Conscientious or Concientous</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <p className="text-lg md:text-xl text-blue-900 leading-relaxed">
          Unsure whether to use &quot;conscientious&quot; or &quot;concientous&quot;? This guide explains the correct spelling, meaning, and usage so you can write with confidence.
        </p>
      </div>
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-red-900">Concientous</h2>
            </div>
            <p className="text-lg md:text-xl text-red-800 mb-4">
              <strong>Incorrect spelling</strong> - This word does not exist in English.
            </p>
            <p className="text-lg md:text-xl text-red-700">
              &quot;Concientous&quot; is a common misspelling of &quot;conscientious&quot;. Always use &quot;conscientious&quot; when referring to someone wishing to do what is right, especially to do one&apos;s work or duty well and thoroughly.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-gray-800">
              <strong>&quot;Incorrect:&quot;</strong> &quot;She is a <span className="text-red-600 font-semibold">concientous</span> student who always completes her assignments.&quot;
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border-l-4 border-blue-500">
            <p className="text-lg md:text-xl text-gray-800">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Is &quot;concientous&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              No, &quot;concientous&quot; is never correct. The only correct form is &quot;conscientious&quot;.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          <strong>Conscientious</strong> is the correct spelling, while <strong>concientous</strong> is always incorrect. Use &quot;conscientious&quot; when referring to someone wishing to do what is right, especially to do one&apos;s work or duty well and thoroughly.
        </p>
      </div>
    </div>
  )
