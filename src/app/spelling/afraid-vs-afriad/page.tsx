...
export const metadata: Metadata = {
  title: 'Afraid or Afriad - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;afraid&quot; and &quot;afriad&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function AfraidVsAfriadPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Afraid or Afriad</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Understanding the difference between &quot;Afraid&quot; or &quot;Afriad&quot;: these commonly confused spellings and how to use them properly.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Afriad</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Afriad&quot; is a misspelling. The correct spelling is &quot;afraid&quot; with the &apos;r&apos; after the &apos;f&apos;.</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Afraid</strong> is spelled with the &apos;r&apos; after the &apos;f&apos;, not after the &apos;a&apos;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;afriad&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: No, &quot;afriad&quot; is never correct. The proper spelling is always &quot;afraid&quot; with the &apos;r&apos; after the &apos;f&apos;.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: How do I remember the correct spelling?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: Remember &quot;afraid&quot; has the &quot;fr&quot; cluster together, not separated.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: The misspelling &quot;afriad&quot; likely occurs because of confusion about the order of the letters or unfamiliarity with the word.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Afraid</strong> is the correct spelling with the &apos;r&apos; after the &apos;f&apos;. It means feeling fear, anxiety, or concern. The misspelling &quot;afriad&quot; is never correct. Use this word when talking about fear, worry, or being concerned about something.</p>
      </div>
    </div>
  )
} 