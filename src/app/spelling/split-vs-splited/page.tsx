          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I <strong>splited</strong> the log yesterday&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;split&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She has <strong>splited</strong> the cost&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;split&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The team <strong>splited</strong> into smaller&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;split&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;They had <strong>splited</strong> the responsibilities&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;split&quot;</p>
              </div>
            </div>
          </div>
