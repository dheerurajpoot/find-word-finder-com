  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Swept&quot; = clean, &quot;Sweped&quot; = wrong</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: Common misspellings include: sweped, swept, swept, swept, and swept. The correct spelling always ends with &quot;pt.&quot;</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-slate-50 p-6 rounded-lg border-l-4 border-slate-500">
        ...
        <p className="text-lg md:text-xl text-slate-800 leading-relaxed">Word Definition Rule: <strong>Swept</strong> is the correct spelling with &quot;pt&quot;: s-w-e-p-t. &quot;Swept&quot; is the past tense and past participle of &quot;sweep&quot; meaning cleaned or cleared using a broom or brush. The incorrect spelling &quot;sweped&quot; is not a recognized English word and should never be used. Always use &quot;swept&quot; when referring to cleaning actions, moving quickly, or winning easily.</p>
      </div>
    </div>
  )
} 