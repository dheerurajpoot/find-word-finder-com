...
export const metadata: Metadata = {
  title: 'Travel or Trawel - Which is Correct? | Word Finder',
  description: 'Learn the difference between &quot;travel&quot; and &quot;trawel&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function TravelVsTrawelPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Travel or Trawel</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;travel&quot; and &quot;trawel&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Trawel</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Trawel&quot; is a common misspelling of the word &quot;travel&quot; and is not correct in standard English.</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-white shadow-md border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-green-900">Trawel:</h3>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="text-lg font-semibold mb-2 text-green-900">Examples:</h4>
                <ul className="text-lg md:text-xl text-green-800 space-y-2">
                  <li>• (Incorrect) She loves to trawel. <span className="text-red-600">(should be &quot;travel&quot;)</span></li>
                </ul>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-red-100">
            <CardContent className="p-6">
              <h4 className="text-xl font-semibold mb-2 text-red-900">Trawel:</h4>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• The correct spelling is <strong>travel</strong>, not &quot;trawel&quot;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;trawel&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: No, &quot;trawel&quot; is not a correct spelling in English.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Use <strong>travel</strong> for the correct spelling. <strong>Trawel</strong> is a misspelling and should be avoided. Always double-check your spelling for accuracy.</p>
      </div>
    </div>
  )
} 