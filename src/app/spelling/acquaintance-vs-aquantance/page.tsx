...
export const metadata: Metadata = {
  title: "Acquaintance or Acquantance - Which is Correct?",
...
export default function AcquaintanceVsAcquantancePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-8">Acquaintance or Acquantance</h1>
      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-lg mb-8">
        ...
        <p className="text-lg md:text-xl text-center">
          Learn the difference between &quot;Acquaintance&quot; and &quot;Acquantance&quot;. These are commonly confused spellings and how to use them correctly.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
          ...
          <div className="text-lg md:text-xl text-red-700">
            This spelling is incorrect. &quot;Acquantance&quot; is missing the &quot;i&quot; - it should be &quot;acquaintance.&quot;
          </div>
        </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-8">
        ...
        <div className="text-lg md:text-xl space-y-4">
          <p>
            <strong>Note:</strong> &quot;Acquaintance&quot; is the correct spelling. &quot;Acquantance&quot; is a common misspelling—remember to include the &quot;i&quot; after the &quot;qu.&quot;
          </p>
          <p>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            ...
            <div className="text-lg md:text-xl text-muted-foreground">The correct spelling is &quot;acquaintance.&quot; &quot;Acquantance&quot; is incorrect—it&apos;s missing the &quot;i.&quot;</div>
          </div>
          ...
          <div className="border-b border-gray-200 pb-4">
            <div className="font-semibold text-lg md:text-xl mb-1">Why is acquantance wrong?</div>
            <div className="text-lg md:text-xl text-muted-foreground">Acquantance is wrong because it&apos;s missing the &quot;i&quot; after the &quot;qu.&quot; The correct spelling is a-c-q-u-a-i-n-t-a-n-c-e.</div>
          </div>
      ...
      <div className="bg-green-50 rounded-lg p-6 mt-8">
        ...
        <div className="text-lg md:text-xl space-y-4">
          ...
          <p>
            <strong>Incorrect spelling:</strong> Acquantance
          </p>
          <p>
            <strong>Meaning:</strong> A person one knows slightly, but not as a close friend; knowledge or experience of something.
          </p>
          <p>
            <strong>Remember:</strong> Always include the &quot;i&quot; in acquaintance. Think of &quot;acquaint&quot; + &quot;ance&quot; to remember the correct spelling.
          </p>
        </div>
      </div>
    </div>
