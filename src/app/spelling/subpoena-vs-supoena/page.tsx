...
export const metadata: Metadata = {
  title: 'Subpoena vs Supoena - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;subpoena&quot; and &quot;supoena&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SubpoenaVsSupoenaPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="bg-gradient-to-br from-slate-100 via-gray-100 to-zinc-100 p-8 rounded-2xl mb-10 border border-slate-200">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700 mt-4">
              &quot;Supoena&quot; is incorrect - remember the &quot;b&quot; in &quot;subpoena&quot;!
            </p>
          </div>
        </div>
          ...
          <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <h3 className="text-3xl font-bold text-red-800 mb-4">Supoena</h3>
                <div className="bg-white p-4 rounded-lg mb-4">
                  <p className="text-xl text-red-700 font-semibold">❌ INCORRECT</p>
                </div>
                <p className="text-lg text-red-700 leading-relaxed">
                  This spelling is missing the &quot;b&quot; in &quot;subpoena&quot; and is never acceptable in English.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-slate-50 border-slate-200">
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold text-slate-900 mb-4">&quot;Sub&quot; (Prefix)</h3>
            ...
            <Card className="bg-gray-50 border-gray-200">
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">&quot;Poena&quot; (Root)</h3>
                <ul className="text-gray-800 space-y-2">
                  <li>• Means &quot;penalty&quot; or &quot;punishment&quot;</li>
                  <li>• Latin origin</li>
                  <li>• Related to &quot;penalty&quot;</li>
                  <li>• Must include &quot;b&quot;</li>
                </ul>
              </CardContent>
            </Card>
            <Card className="bg-zinc-50 border-zinc-200">
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold text-zinc-900 mb-4">&quot;A&quot; (Suffix)</h3>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                  <p className="text-lg text-red-800">&quot;The court issued a <strong>supoena</strong> for the witness&quot; ❌</p>
                  <p className="text-sm text-red-600 mt-1">Should be: &quot;subpoena&quot;</p>
                </div>
                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                  <p className="text-lg text-red-800">&quot;He received a <strong>supoena</strong> to testify&quot; ❌</p>
                  <p className="text-sm text-red-600 mt-1">Should be: &quot;subpoena&quot;</p>
                </div>
                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                  <p className="text-lg text-red-800">&quot;The lawyer served the <strong>supoena</strong> yesterday&quot; ❌</p>
                  <p className="text-sm text-red-600 mt-1">Should be: &quot;subpoena&quot;</p>
                </div>
                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                  <p className="text-lg text-red-800">&quot;She ignored the <strong>supoena</strong> at her own risk&quot; ❌</p>
                  <p className="text-sm text-red-600 mt-1">Should be: &quot;subpoena&quot;</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-yellow-50 border-yellow-300 text-center">
              <CardContent className="p-6">
                ...
                <p className="text-yellow-800">&quot;Subpoena&quot; means court order, remember the &quot;b&quot;</p>
              </CardContent>
            </Card>
            <Card className="bg-blue-50 border-blue-300 text-center">
              <CardContent className="p-6">
                ...
                <p className="text-blue-800">&quot;Poena&quot; root always has a &quot;b&quot;</p>
              </CardContent>
            </Card>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            <Card className="border-l-4 border-slate-500">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-slate-900 mb-3">Q: Why do people misspell &quot;subpoena&quot; as &quot;supoena&quot;?</h3>
                <p className="text-lg text-gray-700">A: The most common error is dropping the &quot;b&quot; from the &quot;poena&quot; root. This happens because the word is long and complex, and people often forget that &quot;poena&quot; always has a &quot;b.&quot;</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-red-500">
              <CardContent className="p-6">
                ...
                <p className="text-lg text-gray-700">A: Break it down: &quot;sub&quot; + &quot;poena.&quot; Remember that &quot;poena&quot; always has a &quot;b,&quot; just like &quot;penalty&quot; and &quot;punish.&quot;</p>
              </CardContent>
            </Card>
        ...
        <div className="bg-gradient-to-r from-slate-600 to-gray-600 text-white p-8 rounded-2xl text-center">
          ...
          <p className="text-xl leading-relaxed mb-6">
            Always remember: <strong>&quot;Subpoena&quot;</strong> has the complete &quot;poena&quot; root with a &quot;b.&quot; 
            <br />
            <strong>&quot;Supoena&quot;</strong> is missing the &quot;b&quot; and is incorrect.
          </p>
          <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
            <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SUB + POENA&quot; - the &quot;b&quot; in poena is essential!</p>
          </div>
        </div>
      </div>
    </div>
