    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              ...
              <ul className="text-green-800 space-y-2">
                <li>• Has &quot;ance&quot; ending</li>
                <li>• Means act of resisting</li>
                <li>• Noun form</li>
          ...
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              ...
              <ul className="text-purple-800 space-y-2">
                <li>• Think &quot;RESIST + ANCE&quot;</li>
                <li>• The &quot;ance&quot; is crucial</li>
                <li>• Like &quot;importance&quot; with &quot;ance&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>resistence</strong> movement fought bravely&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistance&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Electrical <strong>resistence</strong> affects current flow&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistance&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She showed great <strong>resistence</strong> to change&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistance&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>resistence</strong> of the material was tested&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistance&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Electrical resistance</strong> - opposition to current</li>
                <li>• <strong>Civil resistance</strong> - peaceful opposition</li>
                <li>• <strong>Antibiotic resistance</strong> - bacterial immunity</li>
                <li>• <strong>Wind resistance</strong> - air opposition</li>
                <li>• <strong>Friction resistance</strong> - surface opposition</li>
                <li>• <strong>Social resistance</strong> - cultural opposition</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Noun:</strong> &quot;The resistance was strong&quot;</li>
                <li>• <strong>Subject:</strong> &quot;Resistance is futile&quot;</li>
                <li>• <strong>Object:</strong> &quot;I met the resistance&quot;</li>
                <li>• <strong>Possessive:</strong> &quot;Her resistance&quot;</li>
                <li>• <strong>Countable:</strong> &quot;Many resistances&quot;</li>
                <li>• <strong>Abstract concept:</strong> &quot;Resistance matters&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;RESIST + ANCE&quot;</p>
        </div>
      </div>
