...
export const metadata: Metadata = {
  title: 'Accent or Akcent - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;accent&quot; and &quot;akcent&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function AccentVsAkcentPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Accent or Akcent</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;accent&quot; or &quot;akcent&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Akcent</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Akcent&quot; is a common misspelling. The correct spelling is &quot;accent&quot; with a &apos;cc&apos;.</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Accent</strong> is spelled with &apos;cc&apos;, not &quot;k&quot;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;akcent&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: No, &quot;akcent&quot; is never correct. The proper spelling is always &quot;accent&quot; with &apos;cc&apos;.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: How do I remember the correct spelling?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: Remember &quot;accent&quot; has &apos;cc&apos; in the middle, not &apos;k&apos;.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: The misspelling &quot;akcent&quot; happens because the &apos;cc&apos; is sometimes replaced with a &apos;k&apos; due to phonetic similarity.</p>
          </div>
        </div>
      </div>
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        <h2 className="text-2xl font-bold mb-4 text-green-900">Summary</h2>
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Accent</strong> is the correct spelling with &apos;cc&apos;. It refers to pronunciation or a written mark. The misspelling &quot;akcent&quot; is never correct. Use &quot;accent&quot; in language, music, and writing contexts.</p>
      </div>
    </div>
  )
} 