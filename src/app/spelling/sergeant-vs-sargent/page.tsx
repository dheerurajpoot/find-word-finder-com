...
export const metadata: Metadata = {
  title: 'Sergeant vs Sargent - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;sergeant&quot; and &quot;sargent&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SergeantVsSargentPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-indigo-100 via-blue-100 to-cyan-100 p-8 rounded-2xl mb-10 border border-indigo-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Sargent&quot; is always incorrect - remember the &quot;e&quot; not missing letter in &quot;sergeant&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Sargent</h3>
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <ul className="text-blue-800 space-y-2">
                <li>• Military rank</li>
                <li>• Police officer rank</li>
                <li>• Has &quot;e&quot; after &quot;r&quot;</li>
                <li>• Used for authority</li>
              </ul>
            </CardContent>
          </Card>
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Sargent&quot; (Incorrect)</h3>
          ...
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              ...
              <ul className="text-purple-800 space-y-2">
                <li>• Think &quot;SERGEANT&quot;</li>
                <li>• &quot;E&quot; after &quot;r&quot;</li>
                <li>• Like &quot;serve&quot;</li>
                <li>• &quot;E&quot; for authority</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>sargent</strong> gave orders&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He was promoted to <strong>sargent</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The police <strong>sargent</strong> investigated&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Sargent Smith reported for duty&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Sergeant&quot; = authority, &quot;Sargent&quot; = wrong</p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Staff sergeant</strong> - higher rank</li>
                <li>• <strong>Sergeant major</strong> - senior rank</li>
                <li>• <strong>Police sergeant</strong> - law enforcement</li>
                <li>• <strong>Army sergeant</strong> - military rank</li>
                <li>• <strong>Sergeant at arms</strong> - ceremonial role</li>
                <li>• <strong>First sergeant</strong> - unit leader</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Subject:</strong> &quot;The sergeant gave orders&quot;</li>
                <li>• <strong>Object:</strong> &quot;He promoted the sergeant&quot;</li>
                <li>• <strong>Predicate:</strong> &quot;He was a sergeant&quot;</li>
                <li>• <strong>Possessive:</strong> &quot;The sergeant&apos;s orders&quot;</li>
                <li>• <strong>Partitive:</strong> &quot;One of the sergeants&quot;</li>
                <li>• <strong>Appositive:</strong> &quot;Sergeant Johnson&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Why do people confuse &quot;sergeant&quot; and &quot;sargent&quot;?</h3>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Sargent&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SERGEANT = E for authority&quot;</p>
        </div>
      </div>
    </div>
  )
