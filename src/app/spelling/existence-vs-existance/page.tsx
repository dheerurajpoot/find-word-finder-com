...
export const metadata: Metadata = {
  title: "Existence or Existance - Which is Correct?",
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Existence or Existance</h1>
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed bg-gray-50 rounded px-4 py-2 inline-block mx-auto max-w-xl">
          Which spelling is correct, Existence or Existance, and how to use them properly.
        </p>
      </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Existence</span> (noun): The fact or state of living or having objective reality; the state of being.
            </div>
            <div className="mb-2 font-semibold text-lg md:text-xl">Examples:</div>
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>The existence of life on other planets is still unproven.</li>
              <li>Human existence has been studied for centuries.</li>
              <li>The existence of the ancient city was confirmed by archaeologists.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">How to pronounce existence?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct pronunciation is /ɪɡˈzɪstəns/ (ig-ZIS-tuns).</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">What does existence mean?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The fact or state of living or having objective reality; the state of being.</div>
            </div>
          </Card>
        </div>
      </div>
