...
export const metadata: Metadata = {
  title: 'Referendum vs Referenum - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;referendum&quot; and &quot;referenum&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function ReferendumVsReferenumPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-violet-100 p-8 rounded-2xl mb-10 border border-indigo-200">
        <div className="text-center">
          ...
          <div className="inline-flex items-center bg-white px-6 py-3 rounded-full shadow-lg">
            ...
            <span className="text-2xl font-bold text-indigo-600">&quot;Referendum&quot; is Correct</span>
            <span className="text-2xl ml-3">✅</span>
          </div>
          <p className="text-lg text-gray-700 mt-4">
            &quot;Referenum&quot; is always incorrect - remember the &quot;d&quot; in &quot;referendum&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Referenum</h3>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-indigo-50 to-indigo-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-indigo-800 mb-4">Referendum</h3>
              <div className="bg-white p-4 rounded-lg mb-4">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Referendum&quot;</strong> has &quot;d&quot; in the middle and means &quot;direct vote.&quot; 
          <br />
          <strong>&quot;Referenum&quot;</strong> is missing the &quot;d&quot; and is never correct.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;REFER + ENDUM&quot; - &quot;referendum&quot; has &quot;d&quot; in the middle!</p>
        </div>
      </div>
