...
export const metadata: Metadata = {
  title: 'Beginning vs Beggining - Which is Correct? | Word Tips',
  description: 'Learn the correct spelling between "beginning" and "beggining". Discover definitions, examples, and tips to remember the right spelling.',
}

export default function BeginningVsBegginingPage() {
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Beginning or Beggining</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-red-800">Beggining</h2>
            </div>
            <p className="text-lg md:text-xl text-red-700">
              This is the incorrect spelling. &quot;Beggining&quot; is a common misspelling that adds an extra &quot;g&quot;.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="text-lg md:text-xl text-gray-700 space-y-2">
                <li>• The <strong>beginning</strong> of the movie was very exciting.</li>
                <li>• She was <strong>beginning</strong> to understand the concept.</li>
                <li>• At the <strong>beginning</strong> of the year, I made many resolutions.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            ...
            <li>• &quot;Beggining&quot; is a phonetic misspelling that adds an unnecessary extra &quot;g.&quot;</li>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Is &quot;beggining&quot; ever correct?</h3>
              <p className="text-lg md:text-xl text-gray-700">
                No, &quot;beggining&quot; is never correct in standard English. It&apos;s always a misspelling of &quot;beginning.&quot;
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800">What&apos;s the difference between &quot;beginning&quot; and &quot;beggining&quot;?</h3>
              <p className="text-lg md:text-xl text-gray-700">
                &quot;Beginning&quot; is the correct spelling meaning the start of something, while &quot;beggining&quot; is simply incorrect with an extra &quot;g.&quot;
              </p>
            </div>
            <div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
          ...
          <p className="text-lg md:text-xl text-green-800 leading-relaxed">
            <strong>&quot;Beginning&quot;</strong> is the correct spelling, while <strong>&quot;beggining&quot;</strong> is incorrect. The word is formed by adding the suffix &quot;-ing&quot; to &quot;begin,&quot; maintaining the double &quot;n&quot; from the original word. Always use &quot;beginning&quot; when referring to the start of something or as the present participle of &quot;begin.&quot;
          </p>
        </div>
      </div>
    </div>
