...
export const metadata: Metadata = {
  title: 'Scenery vs Scenary - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;scenery&quot; and &quot;scenary&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SceneryVsScenaryPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-violet-100 via-purple-100 to-fuchsia-100 p-8 rounded-2xl mb-10 border border-violet-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Scenary&quot; is always incorrect - remember the &quot;ery&quot; ending in &quot;scenery&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Scenary</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-violet-900 mb-4">&quot;Scenery&quot; (Noun)</h3>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Scenary&quot; (Misspelling)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The coastal <strong>scenery</strong> was spectacular.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;We enjoyed the <strong>scenery</strong> during our hike.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The <strong>scenery</strong> along the river was peaceful.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;This region offers diverse <strong>scenery</strong>.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Beautiful <strong>scenary</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenery&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>scenary</strong> was amazing&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenery&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Coastal <strong>scenary</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenery&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Natural <strong>scenary</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;scenery&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="text-xl font-bold text-blue-900 mb-2">ERY Ending</h3>
              <p className="text-blue-800">&quot;Scenery&quot; ends with &quot;ery&quot; like &quot;bakery&quot; and &quot;mystery&quot;</p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Stunning scenery</strong> - impressive landscape</li>
                <li>• <strong>Diverse scenery</strong> - varied landscape</li>
                <li>• <strong>Rural scenery</strong> - countryside views</li>
                <li>• <strong>Alpine scenery</strong> - mountain views</li>
                <li>• <strong>Desert scenery</strong> - arid landscape</li>
                <li>• <strong>Forest scenery</strong> - woodland views</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Subject:</strong> &quot;The scenery was breathtaking&quot;</li>
                <li>• <strong>Object:</strong> &quot;We photographed the scenery&quot;</li>
                ...
                <li>• <strong>Prepositional object:</strong> &quot;Through the scenery&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-violet-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-violet-900 mb-3">Q: Why do people misspell &quot;scenery&quot; as &quot;scenary&quot;?</h3>
              <p className="text-lg text-gray-700">A: This is a common phonetic spelling error. People hear the word pronounced and try to spell it based on how it sounds, leading to the incorrect &quot;scenary&quot; spelling.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of &quot;scenery&quot; as ending with &quot;ery&quot; like other words: bakery, mystery, delivery. The &quot;ery&quot; ending is a common English suffix.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Scenery&quot;</strong> ends with &quot;ery&quot; and is the only correct spelling. 
          <br />
          <strong>&quot;Scenary&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SCENERY = SCENE + ery ending&quot;</p>
        </div>
      </div>
    </div>
  )
