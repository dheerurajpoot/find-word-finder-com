  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Apple or Aple</h1>
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed bg-gray-50 rounded px-4 py-2 inline-block mx-auto max-w-xl">
          Which spelling is correct, Apple or Aple, and how to use them properly.
        </p>
      </div>
        ...
        <div className="flex-1">
          <Card className="bg-red-50 border border-red-200 rounded-xl p-6 h-full flex flex-col justify-between shadow-none">
            <div>
              ...
              <div className="text-3xl font-extrabold text-red-600 mb-2">Aple</div>
              <div className="text-lg md:text-xl text-gray-700">
                This spelling is incorrect. &quot;Aple&quot; is missing the second &quot;p&quot;.
              </div>
            </div>
          </Card>
        </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded text-yellow-900 text-lg md:text-xl">
        <strong>Note:</strong> &quot;Apple&quot; is the correct spelling. &quot;Aple&quot; is incorrect—remember the double &quot;p&quot; in the middle.
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">Is it aple or apple?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct spelling is &quot;apple.&quot; &quot;Aple&quot; is incorrect—it&apos;s missing the second &quot;p&quot;.</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
