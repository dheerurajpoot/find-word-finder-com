    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I <strong>relized</strong> my mistake too late&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;realized&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She <strong>relized</strong> her dream of becoming&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;realized&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;They <strong>relized</strong> the importance of&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;realized&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He <strong>relized</strong> he had forgotten&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;realized&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Realized potential</strong> - achieved capability</li>
                <li>• <strong>Realized value</strong> - actual worth</li>
                <li>• <strong>Realized dream</strong> - achieved goal</li>
                <li>• <strong>Realized mistake</strong> - became aware of error</li>
                <li>• <strong>Realized importance</strong> - understood significance</li>
                <li>• <strong>Realized truth</strong> - discovered reality</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Past tense:</strong> &quot;I realized the truth&quot;</li>
                <li>• <strong>Past participle:</strong> &quot;I have realized my mistake&quot;</li>
                <li>• <strong>Subject:</strong> &quot;Realizing the truth was difficult&quot;</li>
                <li>• <strong>Object:</strong> &quot;She realized her potential&quot;</li>
                <li>• <strong>Modifier:</strong> &quot;The realized goal&quot;</li>
                <li>• <strong>Predicate:</strong> &quot;That&apos;s what I realized&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;Realized = Real + ize (make real)&quot;</p>
        </div>
      </div>
