      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
          ...
          <ul className="space-y-2">
            <li><Link href="/spelling/asymmetry-vs-assymetry" className="text-blue-700 hover:text-blue-900 underline">Asymmetry vs Assymetry</Link></li>
            <li><Link href="/spelling/believes-vs-belives" className="text-blue-700 hover:text-blue-900 underline">Believes vs Belives</Link></li>
            <li><Link href="/spelling/splendid-vs-spendid" className="text-blue-700 hover:text-blue-900 underline">Splendid vs Spendid</Link></li>
            <li><Link href="/spelling/behaviour-vs-behavor" className="text-blue-700 hover:text-blue-900 underline">Behaviour vs Behaver</Link></li>
            <li><Link href="/spelling/should-vs-shoud" className="text-blue-700 hover:text-blue-900 underline">Should vs Shoud</Link></li>
          </ul>
        </div>
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          ...
          <ul className="space-y-2">
            <li><Link href="/spelling/similar-vs-silimar" className="text-purple-700 hover:text-purple-900 underline">Similar vs Silimar</Link></li>
            <li><Link href="/spelling/apparatus-vs-aparatus" className="text-purple-700 hover:text-purple-900 underline">Apparatus vs Aparatus</Link></li>
            <li><Link href="/spelling/cassette-vs-casete" className="text-purple-700 hover:text-purple-900 underline">Cassette vs Casete</Link></li>
            <li><Link href="/spelling/technology-vs-tecnology" className="text-purple-700 hover:text-purple-900 underline">Technology vs Tecnology</Link></li>
            <li><Link href="/spelling/consensus-vs-concensus" className="text-purple-700 hover:text-purple-900 underline">Consensus vs Concensus</Link></li>
          </ul>
        </div>
