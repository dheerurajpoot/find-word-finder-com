...
export const metadata: Metadata = {
  title: 'Year or Yeer - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;year&quot; and &quot;yeer&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function YearVsYeerPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Year or Yeer</h1>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <p className="text-lg md:text-xl text-blue-900 leading-relaxed">
          Unsure whether to use &quot;year&quot; or &quot;yeer&quot;? This guide explains the correct spelling, meaning, and usage so you can write with confidence.
        </p>
      </div>
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-red-900">Yeer</h2>
            </div>
            <p className="text-lg md:text-xl text-red-800 mb-4">
              <strong>Incorrect spelling</strong> - This word does not exist in English.
            </p>
            <p className="text-lg md:text-xl text-red-700">
              &quot;Yeer&quot; is a common misspelling of &quot;year&quot;. Always use &quot;year&quot; when referring to a period of 12 months.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-gray-800">
              <strong>&quot;Incorrect:&quot;</strong> &quot;A <span className="text-red-600 font-semibold">yeer</span> has 12 months.&quot;
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border-l-4 border-blue-500">
            <p className="text-lg md:text-xl text-gray-800">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Is &quot;yeer&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              No, &quot;yeer&quot; is never correct. The only correct form is &quot;year&quot;.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          <strong>Year</strong> is the correct spelling, while <strong>yeer</strong> is always incorrect. Use &quot;year&quot; when referring to a period of 12 months.
        </p>
      </div>
    </div>
  )
