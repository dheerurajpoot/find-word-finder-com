...
export const metadata: Metadata = {
  title: 'Sustenance vs Substinance - Correct Spelling & Word Definitions | Word Finder',
  description: 'Learn the correct spelling: &quot;sustenance&quot; vs &quot;substinance&quot;. Understand word definitions, usage examples, and avoid common spelling mistakes.',
}

export default function SustenanceVsSubstinancePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-8 rounded-2xl mb-10 border border-indigo-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Substinance&quot; is always incorrect - remember the &quot;sus&quot; in &quot;sustenance&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Substinance</h3>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Ten&quot; (Middle)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Food provides <strong>substinance</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustenance&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The plants need <strong>substinance</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustenance&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He found <strong>substinance</strong> in his faith&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustenance&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The village depends on <strong>substinance</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sustenance&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-yellow-800">&quot;Sustenance&quot; starts with &quot;sus&quot; like &quot;sustain&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Sustenance&quot; = food, &quot;Substinance&quot; = wrong</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Why do people confuse &quot;sustenance&quot; and &quot;substinance&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from similar pronunciation and the fact that &quot;sub&quot; and &quot;sus&quot; can sound similar. Many people don&apos;t realize that &quot;sustenance&quot; starts with &quot;sus.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Use visual aids showing &quot;sustenance&quot; starts with &quot;sus&quot; (like &quot;sustain&quot;), and emphasize that &quot;substinance&quot; is not a real word. Create simple sentences and have them identify which spelling is correct.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-yellow-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Think of &quot;sustenance&quot; as starting with &quot;sus&quot; like other words: sustain, sustenance. The &quot;sus&quot; pattern is consistent and easy to remember.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-cyan-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Common misspellings include: substinance, sustenance, sustenance, sustenance, and sustenance. The correct spelling always starts with &quot;sus.&quot;</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-violet-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-violet-900 mb-3">Q: Why do people often misspell &quot;sustenance&quot; with &quot;sub&quot; instead of &quot;sus&quot;?</h3>
              <p className="text-lg text-gray-700">A: People often confuse &quot;sub&quot; and &quot;sus&quot; because they may not pronounce the &quot;s&quot; clearly, but &quot;sustenance&quot; specifically starts with &quot;sus.&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Sustenance&quot;</strong> starts with &quot;sus&quot; and means &quot;food and drink that supports life.&quot; 
          <br />
          <strong>&quot;Substinance&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SUS + TEN + ANCE = SUSTENANCE&quot;</p>
        </div>
      </div>
    </div>
  )
