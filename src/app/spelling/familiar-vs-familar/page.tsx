  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Familiar or Familar</h1>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Familiar</span> (adjective): Well known from long or close association; recognizable; common.
            </div>
            <div className="mb-2 font-semibold text-lg md:text-xl">Examples:</div>
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>Her face looked familiar to me.</li>
              <li>This is a familiar story.</li>
              <li>He spoke in a familiar tone.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">How to pronounce familiar?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct pronunciation is /fəˈmɪliər/ (fuh-MIL-ee-er).</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">What does familiar mean?</div>
              <div className="text-lg md:text-xl text-muted-foreground">Well known from long or close association; recognizable; common.</div>
            </div>
          </Card>
        </div>
      </div>
