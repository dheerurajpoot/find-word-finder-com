    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              ...
              <ul className="text-green-800 space-y-2">
                <li>• Has &quot;ence&quot; ending</li>
                <li>• Means place of living</li>
                <li>• Noun form</li>
          ...
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              ...
              <ul className="text-purple-800 space-y-2">
                <li>• Think &quot;RESIDE + ENCE&quot;</li>
                <li>• The &quot;ence&quot; is crucial</li>
                <li>• Like &quot;evidence&quot; with &quot;ence&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Her <strong>residance</strong> is in downtown&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;residence&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The official <strong>residance</strong> of the president&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;residence&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;They have a summer <strong>residance</strong> in the mountains&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;residence&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;His primary <strong>residance</strong> is in California&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;residence&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Primary residence</strong> - main home</li>
                <li>• <strong>Official residence</strong> - government home</li>
                <li>• <strong>Summer residence</strong> - seasonal home</li>
                <li>• <strong>Legal residence</strong> - registered address</li>
                <li>• <strong>Permanent residence</strong> - long-term home</li>
                <li>• <strong>Country residence</strong> - rural home</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Noun:</strong> &quot;The residence is beautiful&quot;</li>
                <li>• <strong>Subject:</strong> &quot;Residence matters&quot;</li>
                <li>• <strong>Object:</strong> &quot;I visited the residence&quot;</li>
                <li>• <strong>Possessive:</strong> &quot;Her residence&quot;</li>
                <li>• <strong>Countable:</strong> &quot;Many residences&quot;</li>
                <li>• <strong>Abstract concept:</strong> &quot;Residence is important&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-indigo-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;RESIDE + ENCE&quot;</p>
        </div>
      </div>
