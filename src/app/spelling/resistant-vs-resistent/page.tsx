    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              ...
              <ul className="text-green-800 space-y-2">
                <li>• Has &quot;ant&quot; ending</li>
                <li>• Means offering resistance</li>
                <li>• Adjective form</li>
          ...
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              ...
              <ul className="text-purple-800 space-y-2">
                <li>• Think &quot;RESIST + ANT&quot;</li>
                <li>• The &quot;ant&quot; is crucial</li>
                <li>• Like &quot;important&quot; with &quot;ant&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;This material is <strong>resistent</strong> to heat&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She is <strong>resistent</strong> to change&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The bacteria are <strong>resistent</strong> to antibiotics&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Water-<strong>resistent</strong> materials last longer&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;resistant&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Heat resistant</strong> - withstands high temperatures</li>
                <li>• <strong>Water resistant</strong> - repels water</li>
                <li>• <strong>Stain resistant</strong> - prevents stains</li>
                <li>• <strong>Antibiotic resistant</strong> - immune to antibiotics</li>
                <li>• <strong>Corrosion resistant</strong> - prevents rust</li>
                <li>• <strong>Impact resistant</strong> - withstands force</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Adjective:</strong> &quot;The resistant material&quot;</li>
                <li>• <strong>Predicate:</strong> &quot;The material is resistant&quot;</li>
                <li>• <strong>Comparative:</strong> &quot;More resistant&quot;</li>
                <li>• <strong>Superlative:</strong> &quot;Most resistant&quot;</li>
                <li>• <strong>Compound:</strong> &quot;Heat-resistant&quot;</li>
                <li>• <strong>Modifier:</strong> &quot;Resistant properties&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;RESIST + ANT&quot;</p>
        </div>
      </div>
