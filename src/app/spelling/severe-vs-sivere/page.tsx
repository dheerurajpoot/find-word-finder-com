...
export const metadata: Metadata = {
  title: 'Severe vs Sivere - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;severe&quot; and &quot;sivere&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SevereVsSiverePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-red-100 via-orange-100 to-yellow-100 p-8 rounded-2xl mb-10 border border-red-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Sivere&quot; is always incorrect - remember the &quot;e&quot; before &quot;r&quot; in &quot;severe&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Sivere</h3>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Sivere&quot; (Incorrect)</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The patient has <strong>sivere</strong> symptoms&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;severe&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;This is a <strong>sivere</strong> problem&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;severe&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The storm caused <strong>sivere</strong> damage&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;severe&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He suffered <strong>sivere</strong> injuries&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;severe&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-yellow-800">&quot;Severe&quot; has &quot;e&quot; before &quot;r&quot;, just like &quot;serious&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-50 border-blue-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-blue-800">&quot;Severe&quot; = serious, &quot;Sivere&quot; = wrong</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Why do people confuse &quot;severe&quot; and &quot;sivere&quot;?</h3>
              <p className="text-lg text-gray-700">A: The confusion often stems from pronunciation patterns where the &quot;e&quot; sound before &quot;r&quot; can be subtle. Many people don&apos;t realize that &quot;severe&quot; requires the &quot;e&quot; before &quot;r&quot; for correct spelling.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: Use visual aids like &quot;severe&quot; having &quot;e&quot; before &quot;r&quot; (like &quot;serious&quot;), and create simple sentences. Have them identify which spelling is correct in context.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Severe&quot;</strong> has &quot;e&quot; before &quot;r&quot; and means &quot;intense&quot; or &quot;serious.&quot; 
          <br />
          <strong>&quot;Sivere&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SEVERE = E before R&quot;</p>
        </div>
      </div>
    </div>
  )
