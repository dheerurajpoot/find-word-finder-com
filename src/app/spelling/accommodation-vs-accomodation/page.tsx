  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
          ...
          <Card className="bg-red-50 border border-red-200 rounded-xl p-6 h-full flex flex-col justify-between shadow-none">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700">
                This spelling is incorrect. &quot;Accomodation&quot; is not a valid word in English.
              </div>
            </div>
          </Card>
        </div>
        <div className="flex-1">
          <Card className="bg-green-50 border border-green-200 rounded-xl p-6 h-full flex flex-col justify-between shadow-none">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700">
                This is the correct spelling. &quot;Accommodation&quot; is a noun meaning a place to stay or live.
              </div>
            </div>
          </Card>
        </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Accommodation</span> (noun): A room, group of rooms, or building in which someone may live or stay; lodging or housing.
            </div>
            <div className="mb-2 font-semibold text-lg md:text-xl">Examples:</div>
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>The hotel provides accommodation for up to 200 guests.</li>
              <li>We found affordable accommodation in the city center.</li>
              <li>The university offers student accommodation on campus.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded text-yellow-900 text-lg md:text-xl">
        <strong>Note:</strong> &quot;Accommodation&quot; is the correct spelling. &quot;Accomodation&quot; is a common misspelling—remember, it has two &quot;c&quot;s and two &quot;m&quot;s.
      </div>
        ...
        <div className="space-y-3">
          <Card>
            <div className="p-6">
              ...
              <div className="text-lg md:text-xl text-muted-foreground">The correct word is &quot;accommodation.&quot; &quot;Accomodation&quot; is a common misspelling.</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
          ...
          <Card>
            <div className="p-6">
              ...
              <div className="text-lg md:text-xl text-muted-foreground">A room, group of rooms, or building in which someone may live or stay; lodging or housing.</div>
            </div>
          </Card>
        </div>
      </div>
