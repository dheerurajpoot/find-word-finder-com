    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The company has <strong>sub sidiary</strong> businesses&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subsidiary&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;This is a <strong>sub sidiary</strong> issue&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subsidiary&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>sub sidiary</strong> company&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subsidiary&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Address the <strong>sub sidiary</strong> concerns&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subsidiary&quot;</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think of &quot;subsidiary&quot; as one unified word meaning &quot;secondary company&quot;!</p>
        </div>
      </div>
    </div>
  )
