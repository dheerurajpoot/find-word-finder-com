...
export const metadata: Metadata = {
  title: 'Restaurant vs Resturant - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;restaurant&quot; and &quot;resturant&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RestaurantVsResturantPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-orange-100 via-red-100 to-pink-100 p-8 rounded-2xl mb-10 border border-orange-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Resturant&quot; is always incorrect - remember the &quot;au&quot; in &quot;restaurant&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Resturant</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-orange-900 mb-4">&quot;Restaur&quot; (Root)</h3>
          ...
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">&quot;ant&quot; (Suffix)</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The <strong>restaurant</strong> was fully booked.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;She owns a popular <strong>restaurant</strong> downtown.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The <strong>restaurant</strong> serves Italian cuisine.&quot;</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;We went to a fancy <strong>resturant</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>resturant</strong> was fully&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She owns a popular <strong>resturant</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>resturant</strong> serves&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;restaurant&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-orange-50 border-orange-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-orange-800">&quot;Restaurant&quot; = food place, &quot;Resturant&quot; = wrong spelling</p>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-300 text-center">
            <CardContent className="p-6">
              ...
              <p className="text-red-800">Practice writing &quot;restaurant&quot; to build muscle memory</p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                ...
                <li>• <strong>Family restaurant</strong> - casual dining</li>
                <li>• <strong>Restaurant chain</strong> - multiple locations</li>
                <li>• <strong>Restaurant owner</strong> - business proprietor</li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                ...
                <li>• <strong>Subject:</strong> &quot;Restaurant opened&quot;</li>
                <li>• <strong>Object:</strong> &quot;We visited restaurant&quot;</li>
                <li>• <strong>Possessive:</strong> &quot;Restaurant&apos;s chef&quot;</li>
                <li>• <strong>Plural:</strong> &quot;Several restaurants&quot;</li>
                <li>• <strong>Adjective:</strong> &quot;Restaurant industry&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-orange-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-orange-900 mb-3">Q: Why do people misspell &quot;restaurant&quot; as &quot;resturant&quot;?</h3>
          ...
          <Card className="border-l-4 border-red-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-red-900 mb-3">Q: What&apos;s the etymology of &quot;restaurant&quot;?</h3>
          ...
          <Card className="border-l-4 border-blue-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-blue-900 mb-3">Q: What&apos;s the difference between &quot;restaurant&quot; and &quot;café&quot;?</h3>
              <p className="text-lg text-gray-700">A: &quot;Restaurant&quot; typically refers to a full-service dining establishment with a broader menu, while &quot;café&quot; usually refers to a smaller, more casual establishment often specializing in coffee and light meals.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          ...
          <br />
          <strong>&quot;Resturant&quot;</strong> is never correct in any context.
        </p>
