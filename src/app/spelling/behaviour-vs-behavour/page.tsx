...
export const metadata: Metadata = {
  title: 'Behaviour vs Behavour - Which is Correct? | Word Tips',
  description: 'Learn the correct spelling between "behaviour" and "behavour". Discover definitions, examples, and tips to remember the right spelling.',
}

export default function BehaviourVsBehavourPage() {
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Behaviour or Behavour</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-red-800">Behavour</h2>
            </div>
            <p className="text-lg md:text-xl text-red-700">
              This is the incorrect spelling. &quot;Behavour&quot; is a common misspelling that omits the &quot;i&quot;.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="text-lg md:text-xl text-gray-700 space-y-2">
                <li>• The student&apos;s <strong>behaviour</strong> in class was disruptive.</li>
                <li>• Good <strong>behaviour</strong> is expected in the library.</li>
                <li>• The study focused on consumer <strong>behaviour</strong> patterns.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            ...
            <li>• &quot;Behavour&quot; is a phonetic misspelling that omits the &quot;i&quot; sound.</li>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Is &quot;behavour&quot; ever correct?</h3>
              <p className="text-lg md:text-xl text-gray-700">
                No, &quot;behavour&quot; is never correct in any form of English. It&apos;s always a misspelling of &quot;behaviour&quot; or &quot;behavior.&quot;
              </p>
            </div>
            <div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
          ...
          <p className="text-lg md:text-xl text-green-800 leading-relaxed">
            <strong>&quot;Behaviour&quot;</strong> is the correct British English spelling, while <strong>&quot;behavour&quot;</strong> is incorrect. The word follows British English conventions by retaining the &quot;u&quot; and &quot;i&quot; from its French origin. In American English, the correct spelling is &quot;behavior&quot; (without the &quot;u&quot;).
          </p>
        </div>
      </div>
    </div>
