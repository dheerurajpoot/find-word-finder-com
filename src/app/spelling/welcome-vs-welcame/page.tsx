...
export const metadata: Metadata = {
  title: 'Welcome or Welcame - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;welcome&quot; and &quot;welcame&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function WelcomeVsWelcamePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Welcome or Welcame</h1>
      
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;welcome&quot; and &quot;welcame&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Welcame</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Welcame&quot; is a misspelling. The correct spelling is &quot;welcome&quot; with &quot;come&quot; at the end.</p>
          </CardContent>
        </Card>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mb-8">
        ...
        <p className="text-lg md:text-xl text-green-800">
          <strong>Welcame</strong> is incorrect and should never be used in formal writing.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-red-700">
              <strong>Incorrect:</strong> &quot;<span className="text-red-600 font-semibold">Welcame</span> to our home!&quot; (should be &quot;Welcome&quot;)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          <li>• &quot;Welcome&quot; is spelled with &quot;come&quot; at the end, not &quot;came&quot;</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Is &quot;welcame&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">No, &quot;welcame&quot; is never correct. The correct spelling is always &quot;welcome&quot; with &quot;come&quot; at the end.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">What&apos;s the difference between &quot;welcome&quot; and &quot;came&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">&quot;Welcome&quot; means to greet kindly, while &quot;came&quot; is the past tense of &quot;come&quot; meaning to move toward or arrive at a place.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-lg md:text-xl text-gray-700">Yes, some people incorrectly spell it as &quot;welcame&quot;, possibly confusing it with the past tense of &quot;come&quot;. This is a common spelling mistake.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800">
          <strong>Welcame</strong> is always incorrect. Remember to use &quot;come&quot; at the end, not &quot;came&quot;.
        </p>
      </div>
    </div>
  )
