...
export const metadata: Metadata = {
  title: 'Tattoo vs Tatto - Correct Spelling & Body Art Terminology | Word Finder',
  description: 'Learn the correct spelling: &quot;tattoo&quot; vs &quot;tatto&quot;. Master body art terminology, word origins, and avoid common spelling mistakes.',
}

export default function TattooVsTattoPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="text-center mb-8">
        <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Tattoo vs Tatto</h1>
        <p className="text-xl text-gray-600">Body Art Terminology & Spelling Guide</p>
      </div>

      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-indigo-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Body Art Terminology & Spelling Rules</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Master the correct spelling between &quot;tattoo&quot; and &quot;tatto&quot;. Learn body art terminology, word origins, and proper usage patterns.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Tatto</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Tatto&quot; is incorrect. The proper spelling is &quot;tattoo&quot; with double &quot;o.&quot;</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-white shadow-md border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-red-900">Tatto (word):</h3>
              <p className="text-lg md:text-xl text-gray-800 leading-relaxed mb-2">&quot;Tatto&quot; is a misspelling and is not a valid English word.</p>
              <div className="bg-red-50 p-4 rounded-lg">
                <h4 className="text-lg font-semibold mb-2 text-red-900">Common Error:</h4>
                <ul className="text-lg md:text-xl text-red-800 space-y-2">
                  <li>• &quot;Tatto&quot; is never used in standard English.</li>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-red-100">
            <CardContent className="p-6">
              <h4 className="text-xl font-semibold mb-2 text-red-900">Tatto:</h4>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Tattoo</strong> is spelled with double &quot;o&quot;: tat-too.</li>
            <li>• The word comes from Polynesian &quot;tatau&quot; meaning &quot;mark.&quot;</li>
            <li>• &quot;Tatto&quot; is a common misspelling that should be avoided.</li>
            <li>• Remember: tattoo has double &quot;o&quot; like &quot;too&quot; and &quot;zoo.&quot;</li>
          </ul>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: How do you teach children the difference between &quot;tattoo&quot; and &quot;tatto&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: Use visual aids showing &quot;tattoo&quot; has double &quot;o&quot; (like &quot;too&quot; and &quot;zoo&quot;), and emphasize that &quot;tatto&quot; is not a real word.</p>
          </div>
        </div>
      </div>

      <div className="bg-indigo-50 p-6 rounded-lg border-l-4 border-indigo-500">
        <h2 className="text-2xl font-bold mb-4 text-indigo-900">Body Art Terminology Summary</h2>
        <p className="text-lg md:text-xl text-indigo-800 leading-relaxed">Body Art Rule: <strong>Tattoo</strong> is the correct spelling with double &quot;o&quot;: tat-too. &quot;Tattoo&quot; is a word of Polynesian origin meaning a permanent design on the skin. The incorrect spelling &quot;tatto&quot; violates basic word formation rules and is never acceptable in any context. Always use &quot;tattoo&quot; when referring to body art or permanent skin designs.</p>
      </div>
    </div>
  )
} 