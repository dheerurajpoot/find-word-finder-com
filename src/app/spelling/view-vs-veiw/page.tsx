      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
          ...
          <ul className="space-y-2">
            <li><Link href="/spelling/veiw-vs-view" className="text-blue-700 hover:text-blue-900 underline">Veiw vs View</Link></li>
            <li><Link href="/spelling/recieve-vs-receive" className="text-blue-700 hover:text-blue-900 underline">Recieve vs Receive</Link></li>
            <li><Link href="/spelling/beleive-vs-believe" className="text-blue-700 hover:text-blue-900 underline">Beleive vs Believe</Link></li>
            <li><Link href="/spelling/achieve-vs-acheive" className="text-blue-700 hover:text-blue-900 underline">Achieve vs Acheive</Link></li>
            <li><Link href="/spelling/relieve-vs-releive" className="text-blue-700 hover:text-blue-900 underline">Relieve vs Releive</Link></li>
          </ul>
        </div>
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          ...
          <ul className="space-y-2">
            <li><Link href="/spelling/see-vs-see" className="text-purple-700 hover:text-purple-900 underline">See vs See</Link></li>
            <li><Link href="/spelling/look-vs-look" className="text-purple-700 hover:text-purple-900 underline">Look vs Look</Link></li>
            <li><Link href="/spelling/observe-vs-observe" className="text-purple-700 hover:text-purple-900 underline">Observe vs Observe</Link></li>
            <li><Link href="/spelling/watch-vs-watch" className="text-purple-700 hover:text-purple-900 underline">Watch vs Watch</Link></li>
            <li><Link href="/spelling/notice-vs-notice" className="text-purple-700 hover:text-purple-900 underline">Notice vs Notice</Link></li>
          </ul>
        </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
          ...
          <ul className="space-y-2">
            <li><Link href="/grammar/ie-ei-rules" className="text-green-700 hover:text-green-900 underline">IE vs EI Rules</Link></li>
            <li><Link href="/grammar/verbs" className="text-green-700 hover:text-green-900 underline">Verbs Guide</Link></li>
            <li><Link href="/grammar/nouns" className="text-green-700 hover:text-green-900 underline">Nouns</Link></li>
            <li><Link href="/grammar/etymology" className="text-green-700 hover:text-green-900 underline">Etymology</Link></li>
            <li><Link href="/grammar/latin-roots" className="text-green-700 hover:text-green-900 underline">Latin Roots</Link></li>
          </ul>
        </div>
      </div>
    </div>
