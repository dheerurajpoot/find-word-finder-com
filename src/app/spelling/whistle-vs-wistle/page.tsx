...
export const metadata: Metadata = {
  title: 'Whistle or Wistle - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;whistle&quot; and &quot;wistle&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function WhistleVsWistlePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Whistle or Wistle</h1>
      
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Confused between &quot;whistle&quot; and &quot;wistle&quot;? Learn the correct spelling, meaning, and how to use it properly in your writing.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Wistle</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Wistle&quot; is a misspelling. The correct spelling is &quot;whistle&quot; with an &quot;h&quot; at the beginning.</p>
          </CardContent>
        </Card>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mb-8">
        ...
        <p className="text-lg md:text-xl text-green-800">
          <strong>Wistle</strong> is incorrect and should never be used in formal writing.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-red-700">
              <strong>Incorrect:</strong> &quot;He blew the <span className="text-red-600 font-semibold">wistle</span> to start the game&quot; (should be &quot;whistle&quot;)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          <li>• &quot;Whistle&quot; is spelled with an &quot;h&quot; at the beginning</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Is &quot;wistle&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">No, &quot;wistle&quot; is never correct. The correct spelling is always &quot;whistle&quot; with an &quot;h&quot; at the beginning.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">What&apos;s the difference between &quot;whistle&quot; and &quot;wistle&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">&quot;Whistle&quot; is the correct spelling meaning a high-pitched sound or device, while &quot;wistle&quot; is simply a misspelling that should never be used.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-lg md:text-xl text-gray-700">Yes, some people incorrectly spell it as &quot;wistle&quot;, possibly because they forget the &quot;h&quot;. This is a common spelling mistake.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800">
          <strong>Wistle</strong> is always incorrect. Remember to include the &quot;h&quot; at the beginning when writing this word.
        </p>
      </div>
    </div>
  )
