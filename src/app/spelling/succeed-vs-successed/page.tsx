    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <div className="bg-white p-4 rounded-lg mb-4">
                <p className="text-xl text-rose-700 font-semibold">❌ INCORRECT</p>
              </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-lime-50 to-lime-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <div className="bg-white p-4 rounded-lg mb-4">
                <p className="text-lg text-lime-700 font-semibold">✅ CORRECT</p>
              </div>
          ...
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              ...
              <ul className="text-rose-800 space-y-2">
                <li>• &quot;Successed&quot; is wrong</li>
                <li>• Incorrect verb form</li>
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold text-rose-800 mb-4">❌ Common Mistakes</h3>
            <div className="space-y-4">
              <div className="bg-rose-50 p-4 rounded-lg border-l-4 border-rose-500">
                <p className="text-lg text-rose-800">&quot;He will <strong>successed</strong> in his career.&quot; ❌</p>
                <p className="text-sm text-rose-600 mt-1">Should be: &quot;succeed&quot;</p>
              </div>
              <div className="bg-rose-50 p-4 rounded-lg border-l-4 border-rose-500">
                <p className="text-lg text-rose-800">&quot;They <strong>successed</strong> in their mission.&quot; ❌</p>
                <p className="text-sm text-rose-600 mt-1">Should be: &quot;succeeded&quot;</p>
              </div>
              <div className="bg-rose-50 p-4 rounded-lg border-l-4 border-rose-500">
                <p className="text-lg text-rose-800">&quot;She hopes to <strong>successed</strong> in business.&quot; ❌</p>
                <p className="text-sm text-rose-600 mt-1">Should be: &quot;succeed&quot;</p>
              </div>
              <div className="bg-rose-50 p-4 rounded-lg border-l-4 border-rose-500">
                <p className="text-lg text-rose-800">&quot;The plan will <strong>successed</strong>.&quot; ❌</p>
                <p className="text-sm text-rose-600 mt-1">Should be: &quot;succeed&quot;</p>
              </div>
            </div>
          </div>
