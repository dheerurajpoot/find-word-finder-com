    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-cyan-50 border-cyan-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-cyan-900 mb-4">✅ Correct: &quot;Simple&quot;</h3>
              <div className="space-y-3">
                <p className="text-cyan-800"><strong>•</strong> &quot;This is a simple task.&quot;</p>
                <p className="text-cyan-800"><strong>•</strong> &quot;Keep it simple.&quot;</p>
                <p className="text-cyan-800"><strong>•</strong> &quot;The solution is simple.&quot;</p>
                <p className="text-cyan-800"><strong>•</strong> &quot;She has simple tastes.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Simpel&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;This is a simpel task&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;Keep it simpel&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The solution is simpel&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;She has simpel tastes&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-emerald-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SIMPLE = L before E&quot;</p>
        </div>
      </div>
