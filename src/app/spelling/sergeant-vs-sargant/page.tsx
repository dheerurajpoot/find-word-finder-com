          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>sargant</strong> gave orders&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;He was promoted to <strong>sargant</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The police <strong>sargant</strong> investigated&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Sargant Smith reported for duty&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;sergeant&quot;</p>
              </div>
            </div>
          </div>
