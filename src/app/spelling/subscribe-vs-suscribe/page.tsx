    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-rose-50 border-rose-200">
            <CardContent className="p-6">
              ...
              <ul className="text-rose-800 space-y-2">
                <li>• Means &quot;to write&quot;</li>
                <li>• Latin origin</li>
                <li>• Related to &quot;scribe&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Please <strong>suscribe</strong> to our newsletter&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subscribe&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I want to <strong>suscribe</strong> to the magazine&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subscribe&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She decided to <strong>suscribe</strong> to the service&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subscribe&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Many people <strong>suscribe</strong> to streaming platforms&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;subscribe&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Subscribe to</strong> - sign up for</li>
                <li>• <strong>Subscribe now</strong> - sign up immediately</li>
                <li>• <strong>Subscribe for free</strong> - sign up without cost</li>
                <li>• <strong>Subscribe and save</strong> - sign up for discounts</li>
                <li>• <strong>Subscribe to updates</strong> - receive notifications</li>
                <li>• <strong>Subscribe to premium</strong> - sign up for paid service</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Related Words</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Subscribe</strong> - to sign up</li>
                <li>• <strong>Subscription</strong> - the act of subscribing</li>
                <li>• <strong>Subscriber</strong> - one who subscribes</li>
                <li>• <strong>Scribe</strong> - writer</li>
                <li>• <strong>Describe</strong> - to write about</li>
                <li>• <strong>Prescribe</strong> - to order</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-pink-600 to-rose-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SUB + SCRIBE&quot; - the &quot;b&quot; in scribe is essential!</p>
        </div>
      </div>
    </div>
  )
