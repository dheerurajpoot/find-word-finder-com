  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Grateful or Greatful</h1>
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed bg-gray-50 rounded px-4 py-2 inline-block mx-auto max-w-xl">
          Which spelling is correct, Grateful or Greatful, and how to use them properly.
        </p>
      </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mb-2 text-lg md:text-xl">
              <span className="font-bold">Grateful</span> (adjective): Feeling or showing an appreciation of kindness; thankful; appreciative.
            </div>
            <div className="mb-2 font-semibold text-lg md:text-xl">Examples:</div>
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              <li>I am grateful for your help.</li>
              <li>She was grateful for the opportunity.</li>
              <li>We are grateful to have such supportive friends.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">How to pronounce grateful?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct pronunciation is /ˈɡreɪtfʊl/ (GRAYT-ful).</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">What does grateful mean?</div>
              <div className="text-lg md:text-xl text-muted-foreground">Feeling or showing an appreciation of kindness; thankful; appreciative.</div>
            </div>
          </Card>
        </div>
      </div>
