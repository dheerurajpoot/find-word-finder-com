...
export const metadata: Metadata = {
  title: 'System vs Sistem - Correct Spelling & Word Definitions | Word Finder',
  description: 'Learn the correct spelling: &quot;system&quot; vs &quot;sistem&quot;. Understand word definitions, usage examples, and avoid common spelling mistakes.',
}

export default function SystemVsSistemPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="text-center mb-8">
        <h1 className="text-5xl font-extrabold mb-4 text-gray-900">System vs Sistem</h1>
        <p className="text-xl text-gray-600">Word Definitions & Spelling Guide</p>
      </div>

      <div className="bg-gradient-to-r from-violet-50 to-indigo-50 p-6 rounded-lg mb-8 border-l-4 border-violet-500">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Word Definitions & Spelling Rules</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">Master the correct spelling between &quot;system&quot; and &quot;sistem&quot;. Learn word definitions, usage examples, and proper spelling patterns.</p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Sistem</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">&quot;Sistem&quot; is not a standard English word. The correct spelling is &quot;system.&quot;</p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-white shadow-md border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-red-900">Sistem (word):</h3>
              <p className="text-lg md:text-xl text-gray-800 leading-relaxed mb-2">&quot;Sistem&quot; is not a standard English word and has no recognized meaning.</p>
              <div className="bg-red-50 p-4 rounded-lg">
                <h4 className="text-lg font-semibold mb-2 text-red-900">Common Error:</h4>
                <ul className="text-lg md:text-xl text-red-800 space-y-2">
                  <li>• &quot;Sistem&quot; is not used in standard English.</li>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-red-100">
            <CardContent className="p-6">
              <h4 className="text-xl font-semibold mb-2 text-red-900">Sistem:</h4>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            ...
            <li>• &quot;Sistem&quot; is not a recognized English word.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: How do you teach children the difference between &quot;system&quot; and &quot;sistem&quot;?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: Use visual aids showing &quot;system&quot; starts with &quot;sy&quot; (like &quot;symphony&quot; and &quot;symbol&quot;), and emphasize that &quot;sistem&quot; is not a real word.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-lg md:text-xl text-gray-700">A: Common misspellings include: sistem, sytem, systm, and systme. The correct spelling always starts with &quot;sy&quot; and ends with &quot;em.&quot;</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md border">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;sistem&quot; a word in any other language?</h3>
            <p className="text-lg md:text-xl text-gray-700">A: &quot;Sistem&quot; is the correct spelling in some other languages like Indonesian and Turkish, but in English, it should always be &quot;system.&quot;</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-violet-50 p-6 rounded-lg border-l-4 border-violet-500">
        ...
        <p className="text-lg md:text-xl text-violet-800 leading-relaxed">Word Definition Rule: <strong>System</strong> is the correct spelling with &quot;sy&quot;: s-y-s-t-e-m. &quot;System&quot; is a word of Greek origin meaning a set of connected things or parts forming a complex whole. The incorrect spelling &quot;sistem&quot; is not a recognized English word and should never be used. Always use &quot;system&quot; when referring to organized methods, connected parts, or complex frameworks.</p>
      </div>
    </div>
  )
} 