    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-slate-50 border-slate-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-slate-900 mb-4">✅ Correct: &quot;Source&quot;</h3>
              <div className="space-y-3">
                <p className="text-slate-800"><strong>•</strong> &quot;This is the source of the problem.&quot;</p>
                <p className="text-slate-800"><strong>•</strong> &quot;Cite your source properly.&quot;</p>
                <p className="text-slate-800"><strong>•</strong> &quot;The source is reliable.&quot;</p>
                <p className="text-slate-800"><strong>•</strong> &quot;Check the source.&quot;</p>
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-red-900 mb-4">❌ Incorrect: &quot;Sourse&quot;</h3>
              <div className="space-y-3">
                <p className="text-red-800"><strong>•</strong> &quot;This is the sourse of the problem&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;Cite your sourse properly&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;The sourse is reliable&quot; ❌</p>
                <p className="text-red-800"><strong>•</strong> &quot;Check the sourse&quot; ❌</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="bg-gradient-to-r from-slate-600 to-zinc-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SOURC + E = SOURCE&quot;</p>
        </div>
      </div>
