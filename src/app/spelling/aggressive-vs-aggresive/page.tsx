...
export const metadata: Metadata = {
  title: 'Aggressive vs Aggresive - Which is Correct? | Word Finder',
...
export default function AggressiveVsAggresivePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold text-center mb-6 text-gray-900">Aggressive vs Aggresive</h1>
