...
export const metadata: Metadata = {
  title: 'Surprise vs Supprise - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;surprise&quot; and &quot;supprise&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function SurpriseVsSupprisePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-emerald-100 via-teal-100 to-cyan-100 p-8 rounded-2xl mb-10 border border-emerald-200">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mt-4">
            &quot;Supprise&quot; is always incorrect - remember the &quot;r&quot; comes before &quot;p&quot; in &quot;surprise&quot;!
          </p>
        </div>
      </div>
        ...
        <Card className="transform hover:scale-105 transition-transform duration-300 border-0 shadow-xl bg-gradient-to-br from-red-50 to-red-100">
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-red-800 mb-4">Supprise</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold text-emerald-900 mb-4">&quot;Surprise&quot; (Correct)</h3>
              <ul className="text-emerald-800 space-y-2">
                <li>• Has &quot;r&quot; before &quot;p&quot;</li>
          ...
          <Card className="bg-teal-50 border-teal-200">
            <CardContent className="p-6">
              ...
              <ul className="text-teal-800 space-y-2">
                <li>• &quot;Supprise&quot; is wrong</li>
                <li>• Missing &quot;r&quot; before &quot;p&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;What a wonderful <strong>surprise</strong>!&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;I love to <strong>surprise</strong> my friends.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-lg text-green-800">&quot;The gift was a complete <strong>surprise</strong>.&quot;</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;What a wonderful <strong>supprise</strong>!&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I love to <strong>supprise</strong> my friends&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The gift was a complete <strong>supprise</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Don&apos;t <strong>supprise</strong> me like that&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;surprise&quot;</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-yellow-50 border-yellow-300 text-center">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-yellow-900 mb-2">R Before P Rule</h3>
              <p className="text-yellow-800">&quot;Surprise&quot; has &quot;r&quot; before &quot;p&quot;</p>
            </CardContent>
          </Card>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-6">
          <Card className="border-l-4 border-emerald-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-emerald-900 mb-3">Q: Why do people misspell &quot;surprise&quot; as &quot;supprise&quot;?</h3>
          ...
          <Card className="border-l-4 border-teal-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-teal-900 mb-3">Q: Is &quot;surprise&quot; related to &quot;surface&quot;?</h3>
          ...
          <Card className="border-l-4 border-cyan-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-cyan-900 mb-3">Q: What&apos;s the difference between &quot;surprise&quot; and &quot;shock&quot;?</h3>
          ...
          <Card className="border-l-4 border-amber-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-amber-900 mb-3">Q: What&apos;s the etymology of &quot;surprise&quot;?</h3>
              <p className="text-lg text-gray-700">A: &quot;Surprise&quot; comes from Old French &quot;surprendre&quot; meaning &quot;to overtake&quot; or &quot;to seize.&quot; The &quot;sur&quot; prefix means &quot;over&quot; and &quot;prise&quot; means &quot;to take.&quot;</p>
            </CardContent>
          </Card>

          <Card className="border-l-4 border-indigo-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Q: Can &quot;surprise&quot; be used as a verb?</h3>
              <p className="text-lg text-gray-700">A: Yes! &quot;Surprise&quot; can be both a noun and a verb. As a verb, it means &quot;to cause someone to feel surprise.&quot; For example: &quot;I will surprise you with a gift.&quot;</p>
            </CardContent>
          </Card>

          <Card className="border-l-4 border-lime-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-lime-900 mb-3">Q: What&apos;s the difference between &quot;surprise&quot; and &quot;astonish&quot;?</h3>
              <p className="text-lg text-gray-700">A: &quot;Surprise&quot; is more general and can be positive or negative, while &quot;astonish&quot; implies a stronger reaction of amazement or wonder, usually positive.</p>
            </CardContent>
          </Card>

          <Card className="border-l-4 border-rose-500">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-rose-900 mb-3">Q: How do I use &quot;surprise&quot; in different tenses?</h3>
              <p className="text-lg text-gray-700">A: Present: &quot;I surprise&quot;, Past: &quot;I surprised&quot;, Future: &quot;I will surprise&quot;, Present Perfect: &quot;I have surprised&quot;, Past Perfect: &quot;I had surprised&quot;.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-8 rounded-2xl text-center">
        ...
        <p className="text-xl leading-relaxed mb-6">
          Always remember: <strong>&quot;Surprise&quot;</strong> has &quot;r&quot; before &quot;p&quot; and means &quot;unexpected event.&quot; 
          <br />
          <strong>&quot;Supprise&quot;</strong> is never correct in any context.
        </p>
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SUR + PRI + SE&quot; and remember the &quot;r&quot; comes before &quot;p&quot;!</p>
        </div>
      </div>
    </div>
  )
