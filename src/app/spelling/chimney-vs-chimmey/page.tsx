...
export const metadata: Metadata = {
  title: 'Chimney vs Chimmey - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between "chimney" and "chimmey". Discover definitions, usage examples, and common spelling mistakes.',
  keywords: 'chimney vs chimmey, correct spelling, spelling comparison, English spelling, word confusion',
  openGraph: {
    title: 'Chimney vs Chimmey - Which is Correct?',
    description: 'Learn the correct spelling between "chimney" and "chimmey". Discover definitions, usage examples, and common spelling mistakes.',
    type: 'website',
  },
}

export default function ChimneyVsChimmeyPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Chimney or Chimmey</h1>
      <div className="bg-gradient-to-r from-blue-500 to-green-500 p-6 rounded-lg mb-8">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Which Spelling is Correct?</h2>
        <p className="text-lg md:text-xl text-gray-700">
          Understanding the correct spelling of &quot;Chimney&quot; or &quot;Chimmey&quot;, this architectural structure and common misspellings.
        </p>
      </div>
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-green-50 rounded-lg border-l-4 border-green-500">
          <h3 className="text-2xl font-bold text-green-900 flex items-center">✅ Correct: Chimney</h3>
          <p className="text-lg md:text-xl text-green-800"><strong>Definition:</strong> A vertical structure that provides ventilation for hot flue gases or smoke from a boiler, stove, furnace, or fireplace to the outside atmosphere.</p>
          <p className="text-lg md:text-xl text-green-800"><strong>Part of Speech:</strong> Noun</p>
        </div>
      </div>

      <div className="bg-blue-50 p-6 rounded-lg mb-8">
        <h2 className="text-2xl font-bold mb-4 text-blue-900">Synonyms for Chimney</h2>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <h3 className="text-xl font-semibold mb-2 text-blue-800">Flue</h3>
            <p className="text-lg text-blue-700">Aduct for smoke and waste gases</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-2 text-blue-800">Smokestack</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2 text-blue-800">System</h3>
            <p className="text-lg text-blue-700">A system for removing waste gases</p>
          </div>
        </div>
      </div>
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-4 rounded border-l-4 border-red-500">
            <p className="text-lg text-gray-800"><strong>Incorrect:</strong> &quot;Smoke rose from the <span className="text-red-600 font-semibold">chimmey</span>.&quot;</p>
          </div>
          <div className="bg-white p-4 rounded border-l-4 border-green-500">
      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-blue-200">
            <h3 className="text-xl font-semibold mb-3 text-blue-900">Q: Why do people misspell &quot;chimney&quot; as &quot;chimmey&quot;?</h3>
            <p className="text-lg text-blue-800">This misspelling often occurs because the eyng can be confused with similar-sounding words or patterns. The correct spelling is chimney with ey at theend.</p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-blue-200">
