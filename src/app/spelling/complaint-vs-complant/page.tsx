...
export const metadata: Metadata = {
  title: 'Complaint or Complant - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;complaint&quot; and &quot;complant&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-red-900">Complant</h2>
            </div>
            <p className="text-lg md:text-xl text-red-800 mb-4">
              <strong>Incorrect spelling</strong> - This word does not exist in English.
            </p>
            <p className="text-lg md:text-xl text-red-700">
              &quot;Complant&quot; is a common misspelling of &quot;complaint&quot;. Always use &quot;complaint&quot; when referring to an expression of dissatisfaction.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg border-l-4 border-red-500">
            <p className="text-lg md:text-xl text-gray-800">
              <strong>&quot;Incorrect:&quot;</strong> &quot;She filed a <span className="text-red-600 font-semibold">complant</span> with customer service.&quot;
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border-l-4 border-blue-500">
            <p className="text-lg md:text-xl text-gray-800">
      ...
      <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
        ...
        <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
          <li>• &quot;Complaint&quot; is spelled with &quot;aint&quot; at the end, not &quot;ant&quot;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Is &quot;complant&quot; ever correct?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              No, &quot;complant&quot; is never correct. The only correct form is &quot;complaint&quot;.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">How do I remember the correct spelling?</h3>
            <p className="text-lg md:text-xl text-gray-700">
              Remember that &quot;complaint&quot; ends with &quot;aint&quot;, not &quot;ant&quot;.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">
          <strong>Complaint</strong> is the correct spelling, while <strong>complant</strong> is always incorrect. Use &quot;complaint&quot; when referring to an expression of dissatisfaction or a formal legal statement.
        </p>
      </div>
    </div>
  )
