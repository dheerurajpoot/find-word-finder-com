...
export const metadata: Metadata = {
  title: 'Adequate vs Addiquate - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling between &quot;adequate&quot; and &quot;addiquate&quot;. Discover definitions, usage examples, and common mistakes to avoid.',
}

export default function AdequateVsAddiquatePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
        ...
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
          Understanding the difference between Adequate or Addiquate these commonly confused spellings and how to use them properly.
        </p>
      </div>
        ...
        <Card className="border-2 border-red-500 bg-red-50">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">Incorrect: Addiquate</h3>
            </div>
            <p className="text-lg md:text-xl text-red-700">
              &quot;Addiquate&quot; is a misspelling. The correct spelling has one &apos;d&apos; and &apos;qu&apos; instead of &apos;qui&apos;.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            <li>• <strong>Adequate</strong> is spelled with one &apos;d&apos; and &apos;qu&apos;, not &apos;qui&apos;.</li>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Q: Is &quot;addiquate&quot; ever correct?</h3>
