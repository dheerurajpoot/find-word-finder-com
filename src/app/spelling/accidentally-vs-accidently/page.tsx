...
export default function AccidentallyVsAccidentlyPage() {
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-10">
      {/* Title and subtitle */}
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-extrabold tracking-tight">Accidentally or Accidently</h1>
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed bg-gray-50 rounded px-4 py-2 inline-block mx-auto max-w-xl">
          Which spelling is correct, Accidentally or Accidently, and how to use them properly.
        </p>
      </div>
        ...
        <div className="flex-1">
          <Card className="bg-red-50 border border-red-200 rounded-xl p-6 h-full flex flex-col justify-between shadow-none">
            <div>
              ...
              <div className="text-3xl font-extrabold text-red-600 mb-2">Accidently</div>
              <div className="text-lg md:text-xl text-gray-700">
                This spelling is incorrect. &quot;Accidently&quot; is not a valid word in English.
              </div>
            </div>
          </Card>
        </div>
        <div className="flex-1">
          <Card className="bg-green-50 border border-green-200 rounded-xl p-6 h-full flex flex-col justify-between shadow-none">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700">
                This is the correct spelling. &quot;Accidentally&quot; is an adverb meaning by chance or mistake.
              </div>
            </div>
          </Card>
        </div>
        ...
        <Card>
          <div className="p-6">
            ...
            <ul className="list-disc list-inside ml-4 text-lg md:text-xl text-muted-foreground">
              ...
              <li>I accidentally bumped into him on the street.</li>
              <li>The vase was accidentally broken during the move.</li>
            </ul>
          </div>
        </Card>
      </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded text-yellow-900 text-lg md:text-xl">
        <strong>Note:</strong> &quot;Accidentally&quot; is the correct spelling. &quot;Accidently&quot; is a common misspelling—remember, it has two &quot;l&quot;s before the &quot;y&quot;.
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <Card>
            <div className="p-6">
              <div className="font-semibold text-lg md:text-xl mb-1">Is it accidently or accidentally?</div>
              <div className="text-lg md:text-xl text-muted-foreground">The correct word is &quot;accidentally.&quot; &quot;Accidently&quot; is a common misspelling.</div>
            </div>
          </Card>
          <Card>
            <div className="p-6">
