          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Keep the ingredients <strong>seprate</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;separate&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;We need to <strong>seprate</strong> the files&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;separate&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;These are two <strong>seprate</strong> issues&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;separate&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The twins have <strong>seprate</strong> rooms&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;separate&quot;</p>
              </div>
            </div>
          </div>
