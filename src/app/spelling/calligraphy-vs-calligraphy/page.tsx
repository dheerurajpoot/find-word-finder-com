...
export const metadata: Metadata = {
  title: 'Calligraphy vs Calligraphy - Which is Correct? | Word Finder',
  description: 'Learn the correct spelling: "calligraphy" vs "calligraphy". Discover the proper spelling, definition, usage examples, and tips to remember the correct form.',
  keywords: 'calligraphy, calligraphy, spelling, correct spelling, word comparison, English spelling',
}

export default function CalligraphyVsCalligraphyPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-4xl font-bold text-center mb-8">Calligraphy or Calligraphy</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-2xl font-semibold text-green-800">Calligraphy</h2>
          </div>
        ...
        <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-2xl font-semibold text-red-800">Calligraphy</h2>
          </div>
      ...
      <section className="mb-8">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-lg">
            ...
            <li>Beautiful, stylized lettering</li>
            <li>Traditional writing techniques</li>
            <li>Decorative script and letterforms</li>
          </ul>
        </div>
      </section>
