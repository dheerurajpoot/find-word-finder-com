      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mt-8">
          ...
          <p className="text-lg md:text-xl text-green-800 leading-relaxed">
            <strong>Character</strong> is the correct spelling for a person in a story or a set of qualities. <strong>Charater</strong> is a misspelling and should not be used in any context.
          </p>
        </div>
      </main>
    </>
