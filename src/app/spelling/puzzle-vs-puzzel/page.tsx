    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-amber-50 border-amber-200">
            <CardContent className="p-6">
              ...
              <ul className="text-amber-800 space-y-2">
                <li>• Has a &quot;z&quot; in the middle</li>
                <li>• From Middle English &quot;poselen&quot;</li>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-6">
              ...
              <ul className="text-orange-800 space-y-2">
                <li>• Spelling: z vs no z</li>
                <li>• Meaning: Valid vs invalid</li>
                <li>• Usage: Common vs never</li>
                <li>• Origin: Middle English vs error</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;This <strong>puzzel</strong> is very challenging&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;puzzle&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She loves solving <strong>puzzels</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;puzzles&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>puzzel</strong> pieces fit together perfectly&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;puzzle&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;This math <strong>puzzel</strong> is tricky&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;puzzle&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Jigsaw puzzle</strong> - interlocking pieces</li>
                <li>• <strong>Crossword puzzle</strong> - word game</li>
                <li>• <strong>Logic puzzle</strong> - reasoning game</li>
                <li>• <strong>Math puzzle</strong> - numerical problem</li>
                <li>• <strong>Brain puzzle</strong> - mental challenge</li>
                <li>• <strong>Word puzzle</strong> - language game</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Noun:</strong> &quot;The puzzle is difficult&quot;</li>
                <li>• <strong>Verb:</strong> &quot;This puzzles me&quot;</li>
                <li>• <strong>Subject:</strong> &quot;Puzzles challenge the mind&quot;</li>
                <li>• <strong>Object:</strong> &quot;We solved the puzzle&quot;</li>
                <li>• <strong>Modifier:</strong> &quot;Puzzle pieces&quot;</li>
                <li>• <strong>Plural:</strong> &quot;Many puzzles exist&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;Puzzle = Puz + zle (two parts)&quot;</p>
        </div>
      </div>
