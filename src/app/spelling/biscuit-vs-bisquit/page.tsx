  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
        ...
        <p className="text-lg md:text-xl text-green-800 leading-relaxed">Remember: <strong>Biscuit</strong> is the correct spelling with &quot;ui&quot; (not &quot;ui&quot;). It means a small baked bread product or cookie. The misspelling &quot;bisquit&quot; is never correct in English.</p>
      </div>
    </div>
  )
} 