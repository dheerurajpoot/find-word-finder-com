...
export const metadata: Metadata = {
  title: 'Recipe vs Recepie - Spelling Guide & Examples | Word Finder',
  description: 'Master the difference between &quot;recipe&quot; and &quot;recepie&quot; with our comprehensive spelling guide. Learn proper usage, common errors, and memory tricks.',
}

export default function RecipeVsRecepiePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-gradient-to-br from-lime-50 to-green-50 border-l-4 border-lime-500 p-6 rounded-r-lg mb-8">
        ...
        <p className="text-lg text-lime-700">
          <strong>&quot;Recipe&quot;</strong> is the correct spelling. &quot;Recepie&quot; is a common misspelling that should be avoided.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <Card className="border-0 shadow-lg transform hover:scale-105 transition-transform duration-300">
          <CardContent className="p-6 bg-gradient-to-br from-red-50 to-pink-50 border-l-4 border-red-500">
            <h3 className="text-xl font-bold text-red-700 mb-3">❌ Incorrect: Recepie</h3>
        ...
        <Card className="border-0 shadow-lg transform hover:scale-105 transition-transform duration-300">
          <CardContent className="p-6 bg-gradient-to-br from-lime-50 to-green-50 border-l-4 border-lime-500">
            <h3 className="text-xl font-bold text-lime-700 mb-3">✅ Correct: Recipe</h3>
            <p className="text-lime-600">This is the proper spelling that means &quot;instructions for preparing food dishes.&quot;</p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="border-0 shadow-lg">
          <CardContent className="p-6 bg-gradient-to-br from-red-100 to-pink-100">
            ...
            <p className="text-red-700">
              <strong>Recepie</strong> is a misspelling that often occurs due to phonetic confusion or typing errors.
            </p>
          </CardContent>
        </Card>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="bg-gradient-to-r from-lime-50 to-green-50 border-l-4 border-lime-500 p-4 rounded-r-lg">
              <p className="text-lime-700">This <strong>recipe</strong> for chocolate cake is delicious.</p>
            </div>
            <div className="bg-gradient-to-r from-lime-50 to-green-50 border-l-4 border-lime-500 p-4 rounded-r-lg">
              <p className="text-lime-700">My grandmother&apos;s <strong>recipe</strong> has been passed down for generations.</p>
            </div>
            <div className="bg-gradient-to-r from-lime-50 to-green-50 border-l-4 border-lime-500 p-4 rounded-r-lg">
              <p className="text-lime-700">Follow the <strong>recipe</strong> carefully for best results.</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 p-4 rounded-r-lg">
              <p className="text-red-700">This <strong>recepie</strong> for chocolate cake is delicious. <span className="text-red-500">(Incorrect)</span></p>
            </div>
            <div className="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 p-4 rounded-r-lg">
              <p className="text-red-700">My grandmother&apos;s <strong>recepie</strong> has been passed down for generations. <span className="text-red-500">(Incorrect)</span></p>
            </div>
            <div className="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 p-4 rounded-r-lg">
              <p className="text-red-700">Follow the <strong>recepie</strong> carefully for best results. <span className="text-red-500">(Incorrect)</span></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 bg-gradient-to-br from-lime-100 to-green-100">
              ...
              <p className="text-lime-700">Remember that &quot;recipe&quot; comes from &quot;receive&quot; - both have the &quot;ce&quot; pattern!</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 bg-gradient-to-br from-lime-100 to-green-100">
              ...
              <p className="text-lime-700">The &quot;c&quot; in &quot;recipe&quot; comes before the &quot;i&quot; - think &quot;re&quot; + &quot;cipe&quot;!</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 bg-gradient-to-br from-lime-100 to-green-100">
              ...
              <p className="text-lime-700">Think: &quot;Re&quot; + &quot;cipe&quot; = &quot;recipe&quot; - the &quot;c&quot; is crucial!</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 bg-gradient-to-br from-lime-100 to-green-100">
              ...
              <p className="text-lime-700">Picture the &quot;c&quot; as a cooking pot - it&apos;s essential for the &quot;recipe&quot;!</p>
            </CardContent>
          </Card>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="space-y-2">
              <p className="text-lime-600">• Family <strong>recipe</strong></p>
              <p className="text-lime-600">• Secret <strong>recipe</strong></p>
              <p className="text-lime-600">• Traditional <strong>recipe</strong></p>
              <p className="text-lime-600">• Favorite <strong>recipe</strong></p>
              <p className="text-lime-600">• Cooking <strong>recipe</strong></p>
            </div>
          </div>
          <div>
            <h3 className="text-xl font-bold text-lime-700 mb-4">Grammatical Functions</h3>
            <div className="space-y-2">
              <p className="text-lime-600">• <strong>Noun:</strong> The recipe is delicious</p>
              <p className="text-lime-600">• <strong>Subject:</strong> This recipe requires skill</p>
              <p className="text-lime-600">• <strong>Object:</strong> I love this recipe</p>
              <p className="text-lime-600">• <strong>Possessive:</strong> The recipe&apos;s origin</p>
              <p className="text-lime-600">• <strong>Countable:</strong> One recipe</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">Why do people misspell &quot;recipe&quot; as &quot;recepie&quot;?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">Is &quot;recepie&quot; ever acceptable in any context?</h3>
              <p className="text-gray-700">No, &quot;recepie&quot; is never correct in formal or informal writing. It should always be spelled as &quot;recipe.&quot;</p>
            </CardContent>
          </Card>

          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">What&apos;s the difference between &quot;recipe&quot; and &quot;receipt&quot;?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">Can &quot;recipe&quot; be used as a verb?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">Is &quot;recipe&quot; related to &quot;recipient&quot;?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">What&apos;s the plural form of &quot;recipe&quot;?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">Can &quot;recipe&quot; be used for things other than food?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">What&apos;s the origin of the word &quot;recipe&quot;?</h3>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6 border-l-4 border-lime-500">
              <h3 className="text-lg font-bold text-lime-800 mb-2">How common is the misspelling &quot;recepie&quot;?</h3>
