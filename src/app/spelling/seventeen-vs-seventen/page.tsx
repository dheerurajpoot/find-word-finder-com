    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <ul className="text-blue-800 space-y-2">
                <li>• Means the number &quot;17&quot;</li>
                <li>• Has &quot;ee&quot; in the middle</li>
                <li>• Follows number pattern</li>
          ...
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-6">
              ...
              <ul className="text-purple-800 space-y-2">
                <li>• Think &quot;SEVENTEEN&quot;</li>
                <li>• &quot;EE&quot; in the middle</li>
                <li>• Like &quot;seven&quot;</li>
                <li>• &quot;EE&quot; for extra</li>
              </ul>
            </CardContent>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;I am <strong>seventen</strong> years old&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;seventeen&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;There are <strong>seventen</strong> students&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;seventeen&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The bus arrives at <strong>seventen</strong> minutes&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;seventeen&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;She won <strong>seventen</strong> awards&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;seventeen&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Seventeen years old</strong> - age specification</li>
                <li>• <strong>Seventeen dollars</strong> - monetary amount</li>
                <li>• <strong>Seventeen times</strong> - frequency</li>
                <li>• <strong>Seventeen people</strong> - group size</li>
                <li>• <strong>Seventeen minutes</strong> - time duration</li>
                <li>• <strong>Seventeen items</strong> - quantity</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Cardinal number:</strong> &quot;Seventeen students&quot;</li>
                <li>• <strong>Ordinal form:</strong> &quot;The seventeenth day&quot;</li>
                <li>• <strong>Noun:</strong> &quot;Seventeen is my favorite number&quot;</li>
                <li>• <strong>Adjective:</strong> &quot;Seventeen-year-old student&quot;</li>
                <li>• <strong>Subject:</strong> &quot;Seventeen arrived early&quot;</li>
                <li>• <strong>Object:</strong> &quot;I counted seventeen&quot;</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-l-4 border-purple-500">
            <CardContent className="p-6">
              ...
              <p className="text-lg text-gray-700">A: &quot;Seventeen&quot; comes from Old English &quot;seofontīene&quot; meaning &quot;seven&quot; + &quot;ten.&quot; The word has maintained its meaning of the number 17 throughout its evolution into modern English.</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;SEVENTEEN = EE in the middle&quot;</p>
        </div>
      </div>
    </div>
  )
