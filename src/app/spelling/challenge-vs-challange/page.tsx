...
// Challenge vs Challange spelling comparison page
import React from "react";
import Head from "next/head";

export default function ChallengeVsChallange() {
  return (
    <>
      <Head>
        <title>Challenge or Challange - Which is Correct? Spelling Comparison</title>
        <meta name="description" content="Learn the difference between 'challenge' and 'challange'. Find out the correct spelling, definitions, usage, and common mistakes." />
      </Head>
      <main className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Challenge or Challange</h1>
        <div className="bg-gradient-to-r from-blue-100 to-blue-50 rounded-lg p-4 mb-6">
          <p className="text-lg md:text-xl text-gray-800">
            Unsure if you should write <strong>&quot;challenge&quot;</strong> or <strong>&quot;challange&quot;</strong>? Here&apos;s a quick guide to help you use the correct spelling every time.
          </p>
        </div>
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-1 bg-red-50 border-l-4 border-red-500 rounded-lg p-6">
            <div className="flex items-center mb-2">
              ...
              <span className="text-xl font-bold text-red-700">Challange</span>
            </div>
        ...
        <section className="mb-8">
          ...
          <div>
            <p className="text-lg md:text-xl"><strong>Challange</strong>: <span className="text-red-700">(Incorrect spelling)</span></p>
          </div>
        </section>
        {/* Synonyms Section */}
        <section className="mb-8">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500 mb-8">
          ...
          <ul className="text-lg md:text-xl text-yellow-800 space-y-3">
            ...
            <li>&quot;Challange&quot; is a common typo or misspelling and should be avoided.</li>
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            <p className="font-semibold text-lg md:text-xl">Q: Is &quot;challange&quot; ever correct?</p>
            <p className="text-lg md:text-xl">A: No, &quot;challange&quot; is always a misspelling of &quot;challenge&quot;.</p>
          </div>
          <div className="mb-4">
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500 mt-8">
          ...
          <p className="text-lg md:text-xl text-green-800 leading-relaxed">
            <strong>Challenge</strong> is the correct spelling for a test or obstacle. <strong>Challange</strong> is a misspelling and should not be used in any context.
          </p>
        </div>
      </main>
    </>
