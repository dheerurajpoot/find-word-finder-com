      ...
      <section className="mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          ...
          <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
            ...
            <ul className="space-y-2">
              <li><a href="/spelling/chemistry-vs-chemestry" className="text-purple-700 hover:text-purple-900 underline">Chemistry vs Chemestry</a></li>
              <li><a href="/spelling/chemistry-vs-chemisty" className="text-purple-700 hover:text-purple-900 underline">Chemistry vs Chemisty</a></li>
              <li><a href="/spelling/chemistry-vs-chemestry" className="text-purple-700 hover:text-purple-900 underline">Chemistry vs Chemestry</a></li>
              <li><a href="/spelling/chemistry-vs-chemestry" className="text-purple-700 hover:text-purple-900 underline">Chemistry vs Chemestry</a></li>
              <li><a href="/spelling/chemistry-vs-chemestry" className="text-purple-700 hover:text-purple-900 underline">Chemistry vs Chemestry</a></li>
            </ul>
