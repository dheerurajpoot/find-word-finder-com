                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        ...
                        onChange={(e) => handleQuiz2Change('creative', e.target.value)}
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        type="text"
                        placeholder="Type your answer..."
                        onChange={(e) => handleQuiz2Change('revolutionary', e.target.value)}
                        className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                      {showResults && (
                        <div className="mt-2 p-2 rounded bg-green-50 border border-green-200">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        type="text"
                        placeholder="Type your answer..."
                        onChange={(e) => handleQuiz3Change('intelligent_opposite', e.target.value)}
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        type="text"
                        placeholder="Type your answer..."
                        onChange={(e) => handleQuiz3Change('independent_opposite', e.target.value)}
                        className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                      />
                      {showResults && (
                        <div className="mt-2 p-2 rounded bg-green-50 border border-green-200">
