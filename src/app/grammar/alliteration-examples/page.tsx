...
export default function AlliterationExamplesPage() {
  const examples = [
    { phrase: "Sally sells seashells by the seashore.", sound: "S", type: "Consonance", meaning: "The 's' sound is repeated.", example: "Sally sells seashells by the seashore every summer." },
    { phrase: "Peter Piper picked a peck of pickled peppers.", sound: "P", type: "Consonance", meaning: "The 'p' sound is repeated.", example: "Peter Piper picked a peck of pickled peppers for his picnic." },
    { phrase: "Fuzzy Wuzzy was a bear.", sound: "F/W", type: "Consonance", meaning: "The 'f' and 'w' sounds are repeated.", example: "Fuzzy Wuzzy was a bear, Fuzzy Wuzzy had no hair." },
    { phrase: "How much wood would a woodchuck chuck if a woodchuck could chuck wood?", sound: "W", type: "Consonance", meaning: "The 'w' sound is repeated.", example: "How much wood would a woodchuck chuck if a woodchuck could chuck wood?" },
    { phrase: "Nine nimble noblemen nibbling nuts.", sound: "N", type: "Consonance", meaning: "The 'n' sound is repeated.", example: "Nine nimble noblemen nibbling nuts at noon." },
    { phrase: "Love learning loads.", sound: "L", type: "Consonance", meaning: "The 'l' sound is repeated.", example: "Love learning loads of new things!" },
    { phrase: "Fan of fabulous, fun form-fitting?", sound: "F", type: "Consonance", meaning: "The 'f' sound is repeated.", example: "Fan of fabulous, fun form-fitting clothes?" },
    { phrase: "Eat emu!", sound: "E", type: "Assonance", meaning: "The 'e' vowel sound is repeated.", example: "Eat emu every evening!" },
    { phrase: "Alliteration is maybe your game.", sound: "A", type: "Assonance", meaning: "The 'a' vowel sound is repeated.", example: "Alliteration is maybe your game after all." },
    { phrase: "Ingenious iguanas improvising an intricate impromptu.", sound: "I", type: "Assonance", meaning: "The 'i' vowel sound is repeated.", example: "Ingenious iguanas improvising an intricate impromptu on instruments." },
    { phrase: "Chomp cheese, children.", sound: "Ch", type: "Consonance", meaning: "The 'ch' sound is repeated.", example: "Chomp cheese, children, cheerfully!" },
    { phrase: "Danny likes to eat apples.", sound: "A", type: "Assonance", meaning: "The 'a' vowel sound is repeated.", example: "Danny likes to eat apples and apricots." },
    { phrase: "Quizzical Quiz, kiss me quick.", sound: "Q/K", type: "Consonance", meaning: "The 'k' sound is repeated (spelled with q and k).", example: "Quizzical Quiz, kiss me quick!" },
    { phrase: "Best Buy, Coca Cola, Dunkin Donuts.", sound: "B/C/D", type: "Consonance", meaning: "Brand names with repeated initial sounds.", example: "Best Buy, Coca Cola, and Dunkin Donuts are alliterative brands." },
    { phrase: "Lemon loaves, pepperoni pizza, cheddar cheese.", sound: "L/P/Ch", type: "Consonance", meaning: "Food names with repeated initial sounds.", example: "Lemon loaves, pepperoni pizza, and cheddar cheese are tasty alliterations." }
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {examples.map((item, idx) => (
                <div key={item.phrase} className="bg-purple-50 border-l-4 border-purple-300 rounded-lg shadow-sm p-4">
                  ...
                  <div className="text-gray-700 mb-1"><b>Type:</b> {item.type} | <b>Sound:</b> <span className="text-purple-700 font-bold">{item.sound}</span></div>
