                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        ...
                        onChange={(e) => handleQuiz2Change('teacher', e.target.value)}
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        type="text"
                        placeholder="Type your answer..."
                        onChange={(e) => handleQuiz3Change('generous_opposite', e.target.value)}
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <input
                        type="text"
                        placeholder="Type your answer..."
                        onChange={(e) => handleQuiz3Change('genuine_opposite', e.target.value)}
                        className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-red-500 focus:border-transparent"
                      />
                      {showResults && (
                        <div className="mt-2 p-2 rounded bg-green-50 border border-green-200">
