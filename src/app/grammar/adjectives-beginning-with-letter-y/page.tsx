...
export default function AdjectivesBeginningWithLetterY() {
      ...
      <div className="bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center max-w-3xl mx-auto">
            Discover youthful, yellow, and yummy adjectives starting with the letter Y
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-yellow-500">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The letter Y introduces us to a world of youthful and yellow adjectives that can enhance our language. 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl">
                  <h4 className="font-semibold text-gray-800 mb-4">Choose the correct meaning for each Y-adjective:</h4>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                <Link href="/grammar/adjective-word-start-with-i" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With I
                </Link>
                <Link href="/grammar/adjective-words-beginning-with-n" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With N
                </Link>
                <Link href="/grammar/adjective-words-start-with-b" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With B
                </Link>
                <Link href="/grammar/adjective-words-that-start-with-c" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With C
                </Link>
                <Link href="/grammar/adjectives-beginning-with-g-to-describe-a-person" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With G
                </Link>
                <Link href="/grammar/adjectives-beginning-with-letter-d" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With D
                </Link>
                <Link href="/grammar/adjectives-beginning-with-letter-m" className="block text-yellow-600 hover:text-yellow-800 font-medium">
                  Adjectives Starting With M
                </Link>
                <Link href="/grammar/adjectives-beginning-with-un" className="block text-yellow-600 hover:text-yellow-800 font-medium">
