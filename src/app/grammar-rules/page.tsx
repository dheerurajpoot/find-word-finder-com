    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          examples: ["Independent: I love pizza", "Dependent: when I'm hungry"],
        ...
        },
        {
          ...
          examples: ["in the morning", "running quickly", "very happy"],
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          examples: ["She said, \"Hello\"", "The poem \"The Road Not Taken\""],
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          examples: ["As brave as a lion", "Like a fish out of water"],
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-white/20 px-4 py-2 rounded-full">50+ Rules</span>
              <span className="bg-white/20 px-4 py-2 rounded-full">Interactive Quizzes</span>
              <span className="bg-white/20 px-4 py-2 rounded-full">Examples & Practice</span>
              <span className="bg-white/20 px-4 py-2 rounded-full">Common Mistakes</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Fix the sentence:</h3>
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-lg">
                    <p className="mb-2">I bought apples oranges and bananas.</p>
                    <details className="mt-2">
                      <summary className="cursor-pointer text-blue-600 font-semibold">Show Answer</summary>
                      <p className="mt-2 text-gray-700">Answer: I bought apples, oranges, and bananas.</p>
                    </details>
                  </div>
                  <div className="bg-white p-4 rounded-lg">
                    <p className="mb-2">The team are winning the game.</p>
                    <details className="mt-2">
                      <summary className="cursor-pointer text-blue-600 font-semibold">Show Answer</summary>
                      <p className="mt-2 text-gray-700">Answer: The team is winning the game. (collective noun as singular)</p>
                    </details>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Read Aloud</h3>
                <p className="text-sm text-gray-600">Reading your work aloud helps catch errors and awkward phrasing.</p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Vary Sentence Length</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Proofread Multiple Times</h3>
                <p className="text-sm text-gray-600">Check for different types of errors in each pass.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
              <h2 className="text-3xl font-bold mb-4">Ready to Master Grammar?</h2>
              <p className="text-xl text-blue-100 mb-8">
                Explore our comprehensive grammar resources and practice exercises
              </p>
