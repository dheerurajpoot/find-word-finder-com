					...
					<div className='lg:col-span-3 space-y-8'>
						...
						<div className='bg-white rounded-xl shadow-lg p-8 border border-gray-100'>
							...
							<p className='text-lg text-gray-700 leading-relaxed'>
								...
								clear rules, examples, and explanations. Whether
								you&apos;re a student, professional, or language
								learner, these comprehensive grammar guidelines
								will help you write with confidence and clarity.
							</p>
						</div>
									...
									{commonMistakes.map((mistake, index) => (
										<div
											...
											<div className='mb-3'>
												...
												<p className='text-red-800 font-medium line-through'>
													{mistake.mistake}
												</p>
											</div>
											<div className='mb-3'>
							...
							<CardContent className='p-4'>
								<div className='space-y-3 text-sm'>
									...
									<div className='bg-teal-50 rounded-lg p-3'>
										...
										<p className='text-teal-700'>
											Interactive grammar quizzes and
											tests
										</p>
									</div>
									<div className='bg-teal-50 rounded-lg p-3'>
										...
										<p className='text-teal-700'>
											Grammar checkers and proofreading
											tips
										</p>
									</div>
								</div>
